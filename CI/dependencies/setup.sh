...
set_env pythonLocation "${venv_dir}"
set_env PKG_CONFIG_PATH "${view_dir}/lib/pkgconfig"
set_env Python_ROOT_DIR "${venv_dir}"
set_env Python2_ROOT_DIR "${venv_dir}"
set_env Python3_ROOT_DIR "${venv_dir}"
end_section
