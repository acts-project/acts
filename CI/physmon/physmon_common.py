...
def makeSetup(useGeometricConfig=False) -> PhysmonSetup:
    ...
    setup = PhysmonSetup(
        ...
        digiConfig="/home/frederik/Desktop/CERN-TECH/data/odd-digi-geometric-config.json", #srcdir / "Examples/Algorithms/Digitization/share/odd-digi-geometric-config.json" if useGeometricConfig else srcdir / "thirdparty/OpenDataDetector/config/odd-digi-smearing-config.json",
