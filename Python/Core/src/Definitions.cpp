...
#undef UNIT
  ...
  py::enum_<PdgParticle>(m, "PdgParticle")
      ...
      .value("eUpsilon", PdgParticle::eUpsilon)
      .value("eUpsilon1S", PdgParticle::eUpsilon1S)
      .value("eUpsilon2S", PdgParticle::eUpsilon2S)
      .value("eUpsilon3S", PdgParticle::eUpsilon3S)
      .value("eChiB", PdgParticle::eChiB)
      .value("eJPsi", PdgParticle::eJPsi)
      .value("ePsi2S", PdgParticle::ePsi2S)
      .value("eChiC", PdgParticle::eChiC)
      .value("eEta_c", PdgParticle::eEta_c)
      ...
      .value("eLambdaB", PdgParticle::eLambdaB)
      .value("eSigmaB", PdgParticle::eSigmaB)
      .value("eXiB", PdgParticle::eXiB)
      .value("eLambdaC", PdgParticle::eLambdaC)
      .value("eSigmaC", PdgParticle::eSigmaC)
      .value("eXiC", PdgParticle::eXiC)
      .value("eAntiLambdaB", PdgParticle::eAntiLambdaB)
      .value("eAntiLambdaC", PdgParticle::eAntiLambdaC)
