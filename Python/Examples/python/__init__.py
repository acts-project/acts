...
import acts
from acts import plugins
from acts import _patch_config

from . import ActsExamplesPythonBindings
from acts.examples.ActsExamplesPythonBindings import *
...
class Sequencer(ActsExamplesPythonBindings._Sequencer):
    ...
    class FpeMask(ActsExamplesPythonBindings._Sequencer._FpeMask):
        ...
        _fpe_types_to_enum = {v.name: v for v in acts.plugins.fpe.FpeType.values}
