...
void addFpeMonitoring(py::module_& p) {
  ...
  auto fpem = py::class_<FpeMonitor>(fpe, "FpeMonitor")
  ...
  fpem.def_property_readonly("result", py::overload_cast<>(&FpeMonitor::result),
                             py::return_value_policy::reference_internal)
      .def("rearm", &FpeMonitor::rearm);

  py::class_<FpeMonitor::Result>(fpem, "Result")
