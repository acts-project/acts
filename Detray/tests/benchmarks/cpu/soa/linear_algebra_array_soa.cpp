...
int main(int argc, char** argv) {
  ...
  // vectors
  cfg_s.n_samples(n_samples / simd_size);
  ...
  cfg_d.n_samples(n_samples / simd_size);
  // Leave this to google benchmark
  cfg_d.do_warmup(false);

  using trf_f_t = transform3_bm<array_soa::transform3<float, simd_size>>;
  using trf_d_t = transform3_bm<array_soa::transform3<double, simd_size>>;

  using mat44_transp_f_t =
      matrix_unaryOP_bm<array_soa::matrix_type<float, 4, 4, simd_size>,
                        bench_op::matrix::transpose>;
  using mat44_transp_d_t =
      matrix_unaryOP_bm<array_soa::matrix_type<double, 4, 4, simd_size>,
                        bench_op::matrix::transpose>;
  using mat66_transp_f_t =
      matrix_unaryOP_bm<array_soa::matrix_type<float, 6, 6, simd_size>,
                        bench_op::matrix::transpose>;
  using mat66_transp_d_t =
      matrix_unaryOP_bm<array_soa::matrix_type<double, 6, 6, simd_size>,
                        bench_op::matrix::transpose>;
  using mat88_transp_f_t =
      matrix_unaryOP_bm<array_soa::matrix_type<float, 8, 8, simd_size>,
                        bench_op::matrix::transpose>;
  using mat88_transp_d_t =
      matrix_unaryOP_bm<array_soa::matrix_type<double, 8, 8, simd_size>,
                        bench_op::matrix::transpose>;

  using mat44_add_f_t =
      matrix_binaryOP_bm<array_soa::matrix_type<float, 4, 4, simd_size>,
                         bench_op::matrix::add>;
  using mat44_add_d_t =
      matrix_binaryOP_bm<array_soa::matrix_type<double, 4, 4, simd_size>,
                         bench_op::matrix::add>;
  using mat66_add_f_t =
      matrix_binaryOP_bm<array_soa::matrix_type<float, 6, 6, simd_size>,
                         bench_op::matrix::add>;
  using mat66_add_d_t =
      matrix_binaryOP_bm<array_soa::matrix_type<double, 6, 6, simd_size>,
                         bench_op::matrix::add>;
  using mat88_add_f_t =
      matrix_binaryOP_bm<array_soa::matrix_type<float, 8, 8, simd_size>,
                         bench_op::matrix::add>;
  using mat88_add_d_t =
      matrix_binaryOP_bm<array_soa::matrix_type<double, 8, 8, simd_size>,
                         bench_op::matrix::add>;
  ...
  using mat44_vec_f_t =
      matrix_vector_bm<array_soa::matrix_type<float, 4, 4, simd_size>,
                       array_soa::vector_type<float, 4, simd_size>>;
  using mat44_vec_d_t =
      matrix_vector_bm<array_soa::matrix_type<double, 4, 4, simd_size>,
                       array_soa::vector_type<double, 4, simd_size>>;
  using mat66_vec_f_t =
      matrix_vector_bm<array_soa::matrix_type<float, 6, 6, simd_size>,
                       array_soa::vector_type<float, 6, simd_size>>;
  using mat66_vec_d_t =
      matrix_vector_bm<array_soa::matrix_type<double, 6, 6, simd_size>,
                       array_soa::vector_type<double, 6, simd_size>>;
  using mat88_vec_f_t =
      matrix_vector_bm<array_soa::matrix_type<float, 8, 8, simd_size>,
                       array_soa::vector_type<float, 8, simd_size>>;
  using mat88_vec_d_t =
      matrix_vector_bm<array_soa::matrix_type<double, 8, 8, simd_size>,
                       array_soa::vector_type<double, 8, simd_size>>;
  ...
  // Vector benchmarks
  DETRAY_DEFINE_VECTOR_BENCH(array_soa)
