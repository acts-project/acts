...
if stddev_p == 0:
    outputDir = Path.cwd() / "wt_pos_stddev_0"
elif stddev_p == 20:
    outputDir = Path.cwd() / "wt_pos_stddev_20"
elif stddev_p == 40:
    outputDir = Path.cwd() / "wt_pos_stddev_40"
elif stddev_p == 60:
    outputDir = Path.cwd() / "wt_pos_stddev_60"
elif stddev_p == 80:
    outputDir = Path.cwd() / "wt_pos_stddev_80"
elif stddev_p == 100:
    outputDir = Path.cwd() / "wt_pos_stddev_100"
elif stddev_p == 120:
    outputDir = Path.cwd() / "wt_pos_stddev_120"
elif stddev_p == 140:
    outputDir = Path.cwd() / "wt_pos_stddev_140"
elif stddev_p == 160:
    outputDir = Path.cwd() / "wt_pos_stddev_160"
elif stddev_p == 180:
    outputDir = Path.cwd() / "wt_pos_stddev_180"
elif stddev_p == 200:
    outputDir = Path.cwd() / "wt_pos_stddev_200"
else:
...
if stddev_t == 0:
    outputDir = Path.cwd() / "wt_time_stddev_0"
elif stddev_t == 2:
    outputDir = Path.cwd() / "wt_time_stddev_2"
elif stddev_t == 4:
    outputDir = Path.cwd() / "wt_time_stddev_4"
elif stddev_t == 6:
    outputDir = Path.cwd() / "wt_time_stddev_6"
elif stddev_t == 8:
    outputDir = Path.cwd() / "wt_time_stddev_8"
elif stddev_t == 10:
    outputDir = Path.cwd() / "wt_time_stddev_10"
else:
