...
namespace Test {
  ...
  BOOST_AUTO_TEST_CASE(ExtrapolationCell_start_passive_destination_material_test)
  {
...
// This tests emulates a propagation 
  ...
  BOOST_AUTO_TEST_CASE(ExtrapolationCell_start_navigation_destination_test)
  {
    ...
    const NeutralCurvilinearParameters* sMatParametersPtr = sMatParameters.get();
    ...
    auto pMatParameters = std::make_unique<NeutralCurvilinearParameters>
                                           (nullptr,plane,direction);
    const NeutralCurvilinearParameters* pMatParametersPtr = pMatParameters.get();
    ...
    auto dMatParameters = std::make_unique<NeutralCurvilinearParameters>
                                           (nullptr,destination,direction);
    const NeutralCurvilinearParameters* dMatParametersPtr = dMatParameters.get();
    // fill the material step
    ...
    BOOST_CHECK_EQUAL(ecc.extrapolationSteps[3].parameters.get(),dParametersPtr);
    // the leadParameters should be the pParameters
