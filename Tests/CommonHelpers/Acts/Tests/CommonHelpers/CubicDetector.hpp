...
struct CubicDetector {
    ...
    std::shared_ptr<const Acts::Experimental::Detector> operator()() {
        ...
        auto boundsVol1 =
            std::make_shared<CuboidVolumeBounds>(1.5_m, 0.5_m, 0.5_m);
        ...
        auto detectorVolume1 = Acts::Experimental::DetectorVolumeFactory::construct(
            ...
            geoContext, "Volume1", trafoVol1,
            std::move(boundsVol1), {surfaces[0], surfaces[1]},
        ...
        auto detectorVolume2 = Acts::Experimental::DetectorVolumeFactory::construct(
            Acts::Experimental::defaultPortalAndSubPortalGenerator(), 
            geoContext, "Volume2", trafoVol2,
            std::move(boundsVol2), surfVec,
            std::vector<std::shared_ptr<Acts::Experimental::DetectorVolume>>{},
            Acts::Experimental::tryAllSubVolumes(),
            Acts::Experimental::tryAllPortalsAndSurfaces());
    
        std::vector<std::shared_ptr<Acts::Experimental::DetectorVolume>> detectorVolumes = 
            {detectorVolume1, detectorVolume2};
        ...
        auto portalContainer = 
            Acts::Experimental::detail::CuboidalDetectorHelper::connect(
                geoContext, detectorVolumes, 
                Acts::BinningValue::binX, {}, Acts::Logging::VERBOSE);
