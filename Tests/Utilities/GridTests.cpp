...
namespace Test {
  ...
  BOOST_AUTO_TEST_CASE(grid_interpolation)
  {
    ...
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.5, 1., 1.}})), 15., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.5, 3., 1.}})), 35., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1., 2., 1.}})), 20., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{2., 2., 1.}})), 30., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.5, 1., 4.}})), 55., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.5, 3., 4.}})), 75., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1., 2., 4.}})), 60., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{2., 2., 4.}})), 70., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1., 1., 2.5}})), 30., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1., 3., 2.5}})), 50., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{2., 1., 2.5}})), 40., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{2., 3., 2.5}})), 60., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.5, 2., 2.5}})), 360. / 8, 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{1.3, 2.1, 1.6}})), 32., 1e-6);
    BOOST_CHECK_CLOSE_FRACTION(g.interpolate(Point({{2., 3., 4.}})), 80., 1e-6);
  }
