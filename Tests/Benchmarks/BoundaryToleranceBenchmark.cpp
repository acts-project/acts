...
int main(int /*argc*/, char** /*argv[]*/) {
  ...
  run_all_benches(
      BoundaryTolerance{BoundaryTolerance::AbsoluteBound(0.6, 0.45)},
      "Abs. tolerance", Mode::SlowOutside);
  run_all_benches(BoundaryTolerance{BoundaryTolerance::Chi2Bound(cov, 3.0)},
                  "Cov. tolerance", Mode::SlowOutside);
