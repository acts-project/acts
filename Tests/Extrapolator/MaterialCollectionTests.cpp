...
namespace Test {
      ...
      index)
  {
    ...
    fwd_navigator_options.max_step_size   = 10. * units::_cm;
    fwd_navigator_options.max_path_length = 25 * units::_cm;
    fwd_navigator_options.debug           = debug_mode;
    ...
    fwd_navigator.initialStepFactor = 0.9;
    fwd_navigator.debug             = debug_mode;
    ...
    fwd_materialCollector.debug              = debug_mode;
    ...
    bwd_navigator.initialStepFactor = 0.9;
    bwd_navigator.debug             = debug_mode;
    ...
    bwd_materialCollector.debug              = debug_mode;
    ...
    if (debug_mode) {
      ...
      std::cout << ">>> Backeard Propgation & Navigation output " << std::endl;
