...
#include "Acts/Geometry/CuboidalContainerBuilder.hpp"
...
#include "Acts/Geometry/IndexedRootVolumeFinderBuilder.hpp"
#include "Acts/Geometry/interface/IInternalStructureBuilder.hpp"
