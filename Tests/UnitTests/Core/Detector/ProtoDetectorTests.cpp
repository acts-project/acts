...
Acts::ProtoDetector createProtoDetector() {
  ...
  pixelBarrel.container = Acts::ProtoVolume::ContainerStructure{
      ...
      {Acts::BinningData(Acts::AxisBoundaryType::Bound,
                         Acts::AxisDirection::AxisR, {0., 1.})},
      true};
...
BOOST_AUTO_TEST_CASE(ProtoTrackingGeometryTests) {
  ...
  BOOST_CHECK_EQUAL(cts.constituentBinning[0].axisType,
                    Acts::AxisType::Variable);
  BOOST_CHECK_EQUAL(cts.constituentBinning[0].axisDirection,
  ...
  BOOST_CHECK_EQUAL(cts1.constituentBinning[0].axisType,
                    Acts::AxisType::Variable);
  BOOST_CHECK_EQUAL(cts1.constituentBinning[0].axisDirection,
