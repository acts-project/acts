...
BOOST_AUTO_TEST_CASE(BinSequence) {
  ...
  BOOST_TEST(seq48e0b10B == reference);
  ...
  BOOST_TEST(seq48e1b10B == reference);
  ...
  BOOST_TEST(seq48e3b10B == reference);
  ...
  BOOST_TEST(seq1029e1b20C == reference);
  ...
  BOOST_TEST(seq218e0b20C == reference);
  ...
  BOOST_TEST(seq218e2b20C == reference);
}
