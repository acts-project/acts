...
///
std::vector<Acts::MaybeSharedPtr<Acts::Surface>> unpackSurfaces(
    const std::vector<Acts::Surface*>& surfaces) {
  std::vector<Acts::MaybeSharedPtr<Acts::Surface>> uSurfaces;
...
std::vector<Acts::MaybeSharedPtr<Acts::Surface>> pixelSurfaces(
