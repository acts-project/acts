...
BOOST_AUTO_TEST_CASE(SurfaceVolumeContainment) {
    ...
    BOOST_CHECK_THROW(
        Acts::Experimental::DetectorVolumeFactory::construct(
            portalGenerator, Acts::GeometryContext(), "CubeWithOutofBoundsSurface", 
            Acts::Transform3::Identity(), 
    ...
    BOOST_CHECK_THROW(
        Acts::Experimental::DetectorVolumeFactory::construct(
            portalGenerator, Acts::GeometryContext(), "SmallCubeWithBigCubeInside", 
            Acts::Transform3::Identity(), 
    ...
    auto smallVolumeMisaligned = Acts::Experimental::DetectorVolumeFactory::construct(
