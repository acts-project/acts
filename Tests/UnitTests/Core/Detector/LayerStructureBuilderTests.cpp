...
BOOST_AUTO_TEST_CASE(LayerStructureBuilder_creationRing) {
  ...
  lsConfig.binnings = {ProtoBinning(
      Acts::binPhi, GridAccessHelpers::LocalAccess{1u},
      Acts::detail::AxisBoundaryType::Closed, -M_PI, M_PI, 22u, 1u)};
...
BOOST_AUTO_TEST_CASE(LayerStructureBuilder_creationCylinder) {
  ...
  lsConfig.binnings = {
      Acts::Experimental::ProtoBinning{
          Acts::binZ, GridAccessHelpers::LocalAccess{1u},
          Acts::detail::AxisBoundaryType::Bound, -480., 480., 14u, 1u},
      Acts::Experimental::ProtoBinning(
          Acts::binPhi, GridAccessHelpers::LocalAccess{0u, 0., 1. / 36.},
          Acts::detail::AxisBoundaryType::Closed, -M_PI, M_PI, 32u, 1u)};
