...
static inline std::string run(IVisualization3D& helper, bool triangulate,
  ...
  std::vector<MaybeSharedPtr<Surface>> coneSurfaces;
  ...
  std::vector<MaybeSharedPtr<Surface>> cylinderSurfaces;
  ...
  std::vector<MaybeSharedPtr<Surface>> radialSurfaces;
  ...
  std::vector<MaybeSharedPtr<Surface>> anomalDiscSurfaces;
  ...
  std::vector<MaybeSharedPtr<Surface>> planarSurfaces;
