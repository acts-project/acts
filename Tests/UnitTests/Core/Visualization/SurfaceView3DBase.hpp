...
static inline std::string run(IVisualization3D& helper, bool triangulate,
  ...
  std::vector<SurfaceHandle<Surface>> coneSurfaces;
  ...
  std::vector<SurfaceHandle<Surface>> cylinderSurfaces;
  ...
  std::vector<SurfaceHandle<Surface>> radialSurfaces;
  ...
  std::vector<SurfaceHandle<Surface>> anomalDiscSurfaces;
  ...
  std::vector<SurfaceHandle<Surface>> planarSurfaces;
