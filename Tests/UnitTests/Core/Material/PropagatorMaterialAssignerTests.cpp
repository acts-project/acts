...
BOOST_AUTO_TEST_CASE(FindSurfaceIntersectionsTrackingGeometry) {
  ...
  auto layers =
      lac.layerArray(tContext, {pCylinderLayer}, rMin, rMid, arbitrary, BinningValue::binR);
  ...
  auto volumes =
      tvac.trackingVolumeArray(tContext, {innerVolume, outerVolume}, BinningValue::binR);
