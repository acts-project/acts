...
struct Stepper {
  auto outputStepSize(const PropagatorState::StepperState& /*unused*/) const {
    return std::string{};
  }
...
struct AborterWithResultA {
  ...
  bool operator()(const propagator_state_t& /*unused*/,
                  const stepper_t& /*unused*/,
                  const result_t& /*unused*/) const {
    return true;
  }
};
