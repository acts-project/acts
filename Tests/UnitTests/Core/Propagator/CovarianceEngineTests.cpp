...
BOOST_AUTO_TEST_CASE(covariance_engine_test) {
  ...
  detail::covarianceTransport(covariance,
                              jacobian,
                              transportJacobian,
                              derivatives,
  ...
  detail::covarianceTransport(tgContext,
                              covariance,
                              jacobian,
                              transportJacobian,
                              derivatives,
  ...
  auto curvResult = detail::curvilinearState(covariance,
                                             jacobian,
                                             transportJacobian,
                                             derivatives,
                                             jacobianLocalToGlobal,
  ...
  curvResult = detail::curvilinearState(covariance,
                                        jacobian,
                                        transportJacobian,
                                        derivatives,
                                        jacobianLocalToGlobal,
  ...
  auto boundResult = detail::boundState(tgContext,
                                        covariance,
                                        jacobian,
                                        transportJacobian,
                                        derivatives,
  ...
  boundResult = detail::boundState(tgContext,
                                   covariance,
                                   jacobian,
                                   transportJacobian,
                                   derivatives,
