...
std::vector<TestData> make_test_data(double mag_field_scale = 1.) {
  std::vector<TestData> test_data_list{
      TestData(
          ...
          TestData::kPlane,
          makeVector<double, eBoundSize>({46.5758, 4.5564, -2.38067,
                                              0.72974, 0.73159,
                                              1163.57}),  // param_vec
          ...
          makeVector<double, 3>({-2.64634e-05 * 1000_T,
                                     -4.38183e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPlane,
          makeVector<double, eBoundSize>({-47.2414, -20.7881, 1.46297,
                                              0.926114, 0.723167,
                                              1318.63}),  // param_vec
          makeMatrix<double, eBoundSize, eBoundSize>(
          ...
          makeVector<double, 3>({-7.28154e-06 * 1000_T,
                                     4.91679e-05 * 1000_T,
                                     0.00200021 * 1000_T})),  // magnetic field

      TestData(makeVector<double, 3>(
               ...
               TestData::kPlane,
               makeVector<double, eBoundSize>({5.1223, 16.6267, -3.08166,
                                                   0.0439704, -0.0358564,
                                                   2625.58}),  // param_vec
               makeMatrix<double, eBoundSize, eBoundSize>(
      ...
      TestData(
          ...
          makeVector<double, 3>({-0.000238594 * 1000_T,
                                     -3.95897e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPolarDisk,
          makeVector<double, eBoundSize>({919.923, -0.0334805, 3.06771,
                                              2.75516, 0.106936,
                                              2410.21}),  // param_vec
          makeMatrix<double, eBoundSize, eBoundSize>(
      ...
      TestData(
          ...
          makeVector<double, 3>({-0.000235096 * 1000_T,
                                     3.37809e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPlane,
          makeVector<double, eBoundSize>({43.1027, -20.0508, -2.58378,
                                              2.04794, -0.61896,
                                              1281.4}),  // param_vec
          makeMatrix<double, eBoundSize, eBoundSize>(
      ...
      TestData(
          ...
          makeVector<double, 3>({0.000246188 * 1000_T,
                                     -0.000361053 * 1000_T,
      ...
      TestData(
          ...
          makeMatrix<double, eBoundSize, eBoundSize>(
              {0.000407068, 0.00585003,  -5.06759e-06, -1.4351e-06, 3.49367e-07,
               ...
               89875.7}),  // param cov
          makeVector<double, 3>({-8.32767e-05 * 1000_T,
                                     1.42907e-05 * 1000_T,
      ...
      TestData(
          ...
          makeVector<double, 3>({-5.25166e-05 * 1000_T,
                                     -2.12894e-05 * 1000_T,
      ...
      TestData(
          ...
          makeMatrix<double, 3, 3>(
              {-0.28392, -0.00738357, 0.95882, 0.958496, 0.0249265, 0.284016,
               -0.0259971, 0.999662, -2.22045e-16}),  // surface rot
          TestData::kPlane,
          makeVector<double, eBoundSize>({-31.3391, 22.7156, 0.668348,
                                              1.23223, -0.672912,
                                              887.012}),  // param_vec
          makeMatrix<double, eBoundSize, eBoundSize>(
