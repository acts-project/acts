...
long double computeDtDs(const T_ParticleHypothesis &hypothesis,
                        long double qop) {
...
FreeToPathMatrix computeFreeToPathDerivatives(
    const Vector3 &direction, long double qop, const Vector3 &bfield,
...
constexpr Eigen::Matrix<T, Rows, Cols> makeMatrix(
    std::initializer_list<long double> elements) {
...
std::vector<TestData> make_test_data(long double mag_field_scale = 1.) {
  std::vector<TestData> test_data_list{
      TestData(
          makeVector<long double, 3>(
              {-442.883, -624.094, 857.272}),  // surface center
          makeMatrix<long double, 3, 3>(
              {0.677197, 0.0176111, -0.735591, -0.735342, -0.0191232, -0.677426,
               -0.0259971, 0.999662, -2.22045e-16}),  // surface rot
          TestData::kPlane,
          makeVector<long double, eBoundSize>({46.5758, 4.5564, -2.38067,
                                               0.72974, 0.73159,
                                               1163.57}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({-2.64634e-05 * 1000_T,
                                      -4.38183e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPlane,
          makeVector<long double, eBoundSize>({-47.2414, -20.7881, 1.46297,
                                               0.926114, 0.723167,
                                               1318.63}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({-7.28154e-06 * 1000_T,
                                      4.91679e-05 * 1000_T,
                                      0.00200021 * 1000_T})),  // magnetic field

      TestData(makeVector<long double, 3>(
                   {-100.1, 9.9476e-14, 2623}),  // surface center
               makeMatrix<long double, 3, 3>({-9.4369e-16, -1, -2.22045e-16, -1,
                                              9.4369e-16, 2.09541e-31, 0,
                                              2.22045e-16, -1}),  // surface rot
               TestData::kPlane,
               makeVector<long double, eBoundSize>({5.1223, 16.6267, -3.08166,
                                                    0.0439704, -0.0358564,
                                                    2625.58}),  // param_vec
               makeMatrix<long double, eBoundSize, eBoundSize>(
      ...
      TestData(
          ...
          TestData::kPolarDisk,
          makeVector<long double, eBoundSize>({874.522, -0.0199525, -2.87012,
                                               0.412785, -0.218474,
                                               2144.77}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({-0.000238594 * 1000_T,
                                      -3.95897e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPolarDisk,
          makeVector<long double, eBoundSize>({919.923, -0.0334805, 3.06771,
                                               2.75516, 0.106936,
                                               2410.21}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({0.00036598 * 1000_T,
                                      -5.73626e-06 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPolarDisk,
          makeVector<long double, eBoundSize>({855.523, -0.00206235, 2.78002,
                                               0.430255, 0.430811,
                                               2164.93}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({-0.000235096 * 1000_T,
                                      3.37809e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPlane,
          makeVector<long double, eBoundSize>({43.1027, -20.0508, -2.58378,
                                               2.04794, -0.61896,
                                               1281.4}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({3.50239e-05 * 1000_T,
                                      1.16125e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPolarDisk,
          makeVector<long double, eBoundSize>({878.179, 0.0377489, -0.917117,
                                               0.298851, -0.155266,
                                               2993.62}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>(
              {0.000246188 * 1000_T, -0.000361053 * 1000_T,
      ...
      TestData(
          ...
          makeMatrix<long double, 3, 3>(
              {-0.368695, 0.00958824, -0.929501, -0.929187, 0.0241643, 0.36882,
               0.0259971, 0.999662, -2.22045e-16}),  // surface rot
          TestData::kPlane,
          makeVector<long double, eBoundSize>({-12.7967, -0.0111021, 2.81269,
                                               0.548845, 0.365828,
                                               1466.51}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
              {0.000407068, 0.00585003,  -5.06759e-06, -1.4351e-06, 3.49367e-07,
               ...
               89875.7}),  // param cov
          makeVector<long double, 3>({-8.32767e-05 * 1000_T,
                                      1.42907e-05 * 1000_T,
      ...
      TestData(
          ...
          TestData::kPlane,
          makeVector<long double, eBoundSize>({-15.9238, -9.71785, -2.58798,
                                               0.458544, -0.490701,
                                               1263.01}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({-5.25166e-05 * 1000_T,
                                      -2.12894e-05 * 1000_T,
      ...
      TestData(
          ...
          makeMatrix<long double, 3, 3>(
              {-0.28392, -0.00738357, 0.95882, 0.958496, 0.0249265, 0.284016,
               -0.0259971, 0.999662, -2.22045e-16}),  // surface rot
          TestData::kPlane,
          makeVector<long double, eBoundSize>({-31.3391, 22.7156, 0.668348,
                                               1.23223, -0.672912,
                                               887.012}),  // param_vec
          makeMatrix<long double, eBoundSize, eBoundSize>(
          ...
          makeVector<long double, 3>({1.43009e-05 * 1000_T,
                                      7.04031e-06 * 1000_T,
