...
BOOST_AUTO_TEST_CASE(ProtoLayerHelperTests) {
  ...
  auto radialLayers = plHelper.protoLayers(
      tgContext, cylinderSurfaces, ProtoLayerHelper::SortingConfig(BinningValue::binR, 5.));
  ...
  // Sort into ProtoLayers
  auto discLayersZ = plHelper.protoLayers(tgContext, discSurfaces, {BinningValue::binZ, 5.});
  ...
  auto rSorted = plHelper.protoLayers(
      tgContext, ringSurfaces, ProtoLayerHelper::SortingConfig(BinningValue::binR, 1.));
  ...
  auto rzSorted =
      plHelper.protoLayers(tgContext, ringSurfaces, {{BinningValue::binR, 1.}, {BinningValue::binZ, 5}});
