...
class TestAxis : public IAxis {
 public:
  ...
  std::vector<long double> getBinEdges() const final { return {-1, 1}; }

  long double getMin() const final { return -1.; }

  long double getMax() const final { return 1.; }
...
class MultiGrid1D {
 public:
  ...
  const std::vector<std::size_t>& atPosition(
      const std::array<long double, 1u>& /*position*/) const {
    return e;
  }
...
class MultiGrid2D {
 public:
  ...
  const std::vector<std::size_t>& atPosition(
      const std::array<long double, 2u>& /*position*/) const {
    return e;
  }
