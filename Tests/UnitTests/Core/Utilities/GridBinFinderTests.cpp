...
BOOST_AUTO_TEST_CASE(grid_binfinder_boundTypes) {
  ...
  Acts::Grid gridClosed(Type<long double>, std::move(xAxisClosed));
  ...
  Acts::Grid gridOpen(Type<long double>, std::move(xAxisOpen));
  ...
  Acts::Grid gridBound(Type<long double>, std::move(xAxisBound));
