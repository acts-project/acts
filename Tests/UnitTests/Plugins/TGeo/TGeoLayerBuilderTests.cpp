...
BOOST_AUTO_TEST_CASE(TGeoLayerBuilderTests) {
  ...
  b0Config.parseRanges = {{BinningValue::binR, {0., 40_mm}}, {BinningValue::binZ, {-60_mm, 15_mm}}};
  ...
  eAllConfig.parseRanges = {{BinningValue::binR, {0., 40_mm}}, {BinningValue::binZ, {16_mm, 60_mm}}};
