...
BOOST_AUTO_TEST_CASE(Geant4DetecturSurfaceFactory_Transforms) {
    ...
    Acts::GeometryView3D::drawArrowForward(obj, origin, Acts::Vector3(100,0,0), 1000, 10, Acts::ViewConfig({255, 0, 0}));
    Acts::GeometryView3D::drawArrowForward(obj, origin, Acts::Vector3(0,100,0), 1000, 10, Acts::ViewConfig({0, 255, 0}));
    Acts::GeometryView3D::drawArrowForward(obj, origin, Acts::Vector3(0,0,100), 1000, 10, Acts::ViewConfig({0, 0, 255}));
    Acts::GeometryView3D::drawArrowForward(obj, surface->center(gctx), surface->center(gctx) + 100*normal, 1000, 10, Acts::ViewConfig({0, 255, 0}));
    int k = 0;
    for (auto& [el, surf] : cache.sensitiveSurfaces) {
        ...
        Acts::GeometryView3D::drawSurface(obj, *surf, gctx, Acts::Transform3::Identity(), vCfg);
        k++;
    }
