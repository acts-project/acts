...
BOOST_AUTO_TEST_CASE(GlobalSubSpaceTests2D) {
  ...
  const std::tuple<Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binX, Acts::BinningValue::binY>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binY, Acts::BinningValue::binX>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binX, Acts::BinningValue::binZ>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binZ, Acts::BinningValue::binX>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binY, Acts::BinningValue::binZ>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binZ, Acts::BinningValue::binY>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binR, Acts::BinningValue::binPhi>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binPhi, Acts::BinningValue::binR>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binZ, Acts::BinningValue::binPhi>,
                   Acts::GridAccess::GlobalSubspace<Acts::BinningValue::binPhi, Acts::BinningValue::binZ>>
      sspace2D = {};
