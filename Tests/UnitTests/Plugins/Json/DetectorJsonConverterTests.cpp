...
BOOST_AUTO_TEST_CASE(BeamPipeEndcapBarrelDetector) {
  ...
  ccBarrelBuilderCfg.axisDirections = {Acts::AxisDirection::AxisR};
  ...
  ccBarrelEcBuilderCfg.builders = {endcapBuilders[0u], ccBarrelBuilder,
                                   endcapBuilders[1u]};
  ccBarrelEcBuilderCfg.axisDirections = {Acts::AxisDirection::AxisZ};
  ...
  detCompBuilderCfg.axisDirections = {Acts::AxisDirection::AxisR};
