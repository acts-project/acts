...
BOOST_AUTO_TEST_CASE(ReadingWritingFull) {
    ...
    GeometryIdentifier geoId2 = GeometryIdentifierJsonConverter::decodeIdentifier(j);
...
BOOST_AUTO_TEST_CASE(ReadingWritingCompact) {
    ...
    nlohmann::json j = GeometryIdentifierJsonConverter::encodeIdentifier(geoId, true);
