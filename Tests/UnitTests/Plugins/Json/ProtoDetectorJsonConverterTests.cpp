...
BOOST_AUTO_TEST_CASE(ProtoDetectorRoundTrip) {
  ...
  beamPipeContainer.container = Acts::ProtoVolume::ContainerStructure{
      {beamPipe},
      {Acts::BinningData(Acts::AxisBoundaryType::Bound, AxisDirection::AxisR,
                         {0., 1.})},
      true};
  ...
  pixelNec.container = Acts::ProtoVolume::ContainerStructure{
      ...
      {Acts::BinningData(Acts::AxisBoundaryType::Bound, AxisDirection::AxisZ,
                         {0., 1.})},
      true};

  Acts::BinningData pixEcBinningR = Acts::BinningData(
      Acts::AxisBoundaryType::Bound, AxisDirection::AxisR, 2., 0., 1.);
  Acts::BinningData pixEcBinningPhi =
      Acts::BinningData(Acts::AxisBoundaryType::Closed, AxisDirection::AxisPhi,
                        30., -std::numbers::pi, std::numbers::pi);
  ...
  Acts::BinningData sstripEcBinningR = Acts::BinningData(
      Acts::AxisBoundaryType::Bound, AxisDirection::AxisR, 3., 0., 1.);
  Acts::BinningData sstripEcBinningPhi =
      Acts::BinningData(Acts::AxisBoundaryType::Closed, AxisDirection::AxisPhi,
                        42., -std::numbers::pi, std::numbers::pi);
