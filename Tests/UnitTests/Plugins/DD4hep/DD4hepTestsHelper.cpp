...
dd4hep::Transform3D DD4hepTestsHelper::createTransform(
  ...
  double cx = Acts::detail::getAttrValueOr<double>(x_det_comp, "cx", 0.);
  double cy = Acts::detail::getAttrValueOr<double>(x_det_comp, "cy", 0.);
  double cz = Acts::detail::getAttrValueOr<double>(x_det_comp, "cz", 0.);

  double xx = Acts::detail::getAttrValueOr<double>(x_det_comp, "xx", 1.);
  double xy = Acts::detail::getAttrValueOr<double>(x_det_comp, "xy", 0.);
  double xz = Acts::detail::getAttrValueOr<double>(x_det_comp, "xz", 0.);

  double yx = Acts::detail::getAttrValueOr<double>(x_det_comp, "yx", 0.);
  double yy = Acts::detail::getAttrValueOr<double>(x_det_comp, "yy", 1.);
  double yz = Acts::detail::getAttrValueOr<double>(x_det_comp, "yz", 0.);
