...
struct Fixture {
  ...
  Fixture(double energyLoss, Acts::MaybeSharedPtr<Acts::Surface> surface_)
...
Acts::MaybeSharedPtr<Acts::Surface> makeEmptySurface() {
  auto surface =
...
Acts::MaybeSharedPtr<Acts::Surface> makeMaterialSurface() {
