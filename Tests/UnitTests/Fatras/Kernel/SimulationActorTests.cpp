...
struct Fixture {
  ...
  Fixture(double energyLoss, Acts::SurfaceHandle<Acts::Surface> surface_)
...
Acts::SurfaceHandle<Acts::Surface> makeEmptySurface() {
  auto surface =
...
Acts::SurfaceHandle<Acts::Surface> makeMaterialSurface() {
