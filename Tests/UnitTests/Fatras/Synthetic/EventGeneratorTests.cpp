...
DetectorLayout makeTestLayout() {
  ...
  description.beamPipeMaterial = SurfaceMaterial{sensor};
  description.barrelRadii = {34.f, 99.f, 160.f, 228.f};
  description.barrelHalfLengthsZ = {250.f, 250.f, 250.f, 250.f};
  description.barrelMaterials.assign(4, SurfaceMaterial{sensor});
  description.barrelModules = 1;
  for (const float absZ : {400.f, 600.f, 800.f}) {
    description.discs.push_back(
        DiscDescription{absZ, {{30.f, 200.f}}, SurfaceMaterial{sensor}});
  }
...
BOOST_AUTO_TEST_CASE(ModuleOverlapStaggersASecondSpacePoint) {
  ...
  description.barrelHalfLengthsZ = {600.f, 600.f, 600.f, 600.f};
  description.barrelOverlapProbabilities = {1.f, 1.f, 1.f, 1.f};
  description.barrelOverlapOffset = offset;
...
BOOST_AUTO_TEST_CASE(ModuleOverlapStaggersADiscAwayFromTheOrigin) {
  ...
  BarrelEndcapDescription description;
  description.discs.push_back(DiscDescription{absZ, {{30.f, 200.f}}, {}});
  description.discOverlapProbability = 1.f;
  description.discOverlapOffset = offset;
  const DetectorLayout layout = makeLayout(description);
