...
BOOST_AUTO_TEST_CASE(WithoutInteraction) {
  ...
  CHECK_CLOSE_REL(
      h.unitDirectionBefore(), Hit::Vector3(1, 1, 1).normalized(), eps);
  CHECK_CLOSE_REL(
      h.unitDirectionAfter(), Hit::Vector3(1, 1, 1).normalized(), eps);
...
BOOST_AUTO_TEST_CASE(WithEnergyLoss) {
  ...
  CHECK_CLOSE_OR_SMALL(
      h.unitDirectionBefore(), Hit::Vector3(1, 0, 0), eps, eps);
...
BOOST_AUTO_TEST_CASE(WithScattering) {
  ...
  CHECK_CLOSE_OR_SMALL(h.momentum4After(), m41, eps, eps);
  CHECK_CLOSE_OR_SMALL(
      h.unitDirectionBefore(), Hit::Vector3(1, 0, 1).normalized(), eps, eps);
  CHECK_CLOSE_OR_SMALL(
      h.unitDirectionAfter(), Hit::Vector3(0, -1, 1).normalized(), eps, eps);
...
BOOST_AUTO_TEST_CASE(WithEverything) {
  ...
  CHECK_CLOSE_OR_SMALL(h.momentum4After(), m41, eps, eps);
  CHECK_CLOSE_REL(
      h.unitDirectionBefore(), Hit::Vector3(3, 2, 2).normalized(), eps);
  CHECK_CLOSE_REL(
      h.unitDirectionAfter(), Hit::Vector3(2, 1, 2).normalized(), eps);
  CHECK_CLOSE_REL(
      h.unitDirection(),
