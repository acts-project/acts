...
BOOST_AUTO_TEST_SUITE(BoostHistogramSuite)

BOOST_AUTO_TEST_CASE(BoostHistogram1D_UniformBinning) {
  auto binning = PlotHelpers::Binning::Uniform("x", 10, 0.0, 10.0);
  BoostHistogram1D hist("test", "Test Histogram", binning);
...
BOOST_AUTO_TEST_CASE(BoostHistogram1D_VariableBinning) {
  // Create histogram with variable binning
  std::vector<double> edges = {0.0, 1.0, 3.0, 7.0, 10.0};
  auto binning = PlotHelpers::Binning::Variable("x", edges);
  BoostHistogram1D hist("test_var", "Test Variable Binning", binning);
...
BOOST_AUTO_TEST_CASE(BoostHistogram1D_LogarithmicBinning) {
  ...
  BoostHistogram1D hist("test_log", "Test Logarithmic Binning", binning);
...
BOOST_AUTO_TEST_CASE(BoostHistogram2D_FillAndAccess) {
  auto xBinning = PlotHelpers::Binning::Uniform("x", 10, 0.0, 10.0);
  auto yBinning = PlotHelpers::Binning::Uniform("y", 10, -5.0, 5.0);
  BoostHistogram2D hist("test_2d", "Test 2D Histogram", xBinning, yBinning);
...
BOOST_AUTO_TEST_CASE(BoostHistogram2D_VariableBinning) {
  ...
  auto xBinning = PlotHelpers::Binning::Variable("eta", xEdges);
  auto yBinning = PlotHelpers::Binning::Variable("res", yEdges);
  BoostHistogram2D hist("res_vs_eta", "Residual vs Eta", xBinning, yBinning);
...
BOOST_AUTO_TEST_CASE(BoostHistogram1D_UnderflowOverflow) {
...
BOOST_AUTO_TEST_CASE(BoostHistogram1D_EmptyHistogram) {
  auto binning = PlotHelpers::Binning::Uniform("x", 10, -5.0, 5.0);
  BoostHistogram1D hist("empty", "Empty Histogram", binning);
