...
namespace Test {
  ...
  BOOST_AUTO_TEST_CASE(neighborhood)
  {
    ...
    BOOST_CHECK(a4.neighborHoodIndices(1, 1).collect() == bins_t({1, 2, 10}));
    BOOST_CHECK(a4.neighborHoodIndices(11, 1).collect() == bins_t({}));
    BOOST_CHECK(a4.neighborHoodIndices(10, 1).collect() == bins_t({1, 9, 10}));
    BOOST_CHECK(a4.neighborHoodIndices(10, {0, 1}).collect() == bins_t({1, 10}));
    ...
    BOOST_CHECK(a4.neighborHoodIndices(1, 2).collect() == bins_t({1, 2, 3, 9, 10}));
    BOOST_CHECK(a4.neighborHoodIndices(11, 2).collect() == bins_t({}));
    BOOST_CHECK(a4.neighborHoodIndices(10, 2).collect() == bins_t({1, 2, 8, 9, 10}));
    ...
    BOOST_CHECK(a6.neighborHoodIndices(1, 1).collect() == bins_t({1, 2, 5}));
    BOOST_CHECK(a6.neighborHoodIndices(6, 1).collect() == bins_t({}));
    BOOST_CHECK(a6.neighborHoodIndices(5, 1).collect() == bins_t({1, 4, 5}));
    BOOST_CHECK(a6.neighborHoodIndices(5, {0, 1}).collect() == bins_t({1, 5}));
    ...
    BOOST_CHECK(a6.neighborHoodIndices(1, 2).collect() == bins_t({1, 2, 3, 4, 5}));
    BOOST_CHECK(a6.neighborHoodIndices(6, 2).collect() == bins_t({}));
    BOOST_CHECK(a6.neighborHoodIndices(5, 2).collect() == bins_t({1, 2, 3, 4, 5}));
