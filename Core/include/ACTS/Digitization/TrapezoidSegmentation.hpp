...
namespace Acts {
  ...
  ///      (the lorentzShift is not taken into account fro trapezoidal elements yet @TODO)
  ///  
  class TrapezoidSegmentation : public Segmentation {
        public:
          ...
          private:
            ...
            double projectLocX(const Vector2D &localPos) const;
    ...
    TrapezoidSegmentation::moduleBounds() const { return (*(m_activeBounds.get())); }
    
    inline size_t 
    TrapezoidSegmentation::numCellsX() const { return m_binsX; }
        
    inline size_t 
    TrapezoidSegmentation::numCellsY() const { return m_binsY; }
