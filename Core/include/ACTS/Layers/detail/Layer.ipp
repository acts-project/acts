                             ...
                             const ICompatibilityEstimator*    ice) const
{
  ...
  if ( m_surfaceArray && ( collectPS 
       || (collectMaterial && m_ssSensitiveSurfaces>1) ) ){
  ...
  if (tSurface != layerSurface 
      && layerSurface != startSurface
      && layerSurface != endSurface 
      && (collectPassive || (collectMaterial && layerSurface->associatedMaterial()))){
      testCompatibleSurface(cSurfaces,
                            *layerSurface,
                            pos,
                            dir,
