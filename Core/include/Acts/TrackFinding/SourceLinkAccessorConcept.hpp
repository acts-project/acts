...
// clang-format off
    template <typename S>
      struct SourceLinkAccessorConcept {
        ...
        constexpr static bool count_exists = has_method<const S, size_t,
         count_t, const typename S::container_type&, 
         const typename S::key_type&>;
        static_assert(count_exists, "count method not found");
        constexpr static bool equal_range_exists = has_method<const S, std::pair<typename S::const_iterator, typename S::const_iterator>, equal_range_t, 
         const typename S::container_type&, const typename S::key_type&>;
	...
	constexpr static bool value = require<container_type_exists, key_type_exists, value_type_exists, const_iterator_exists, count_exists, equal_range_exists, at_exists>; 
      };
// clang-format on
}  // namespace SourceLinkAccessor
}  // namespace Concepts
