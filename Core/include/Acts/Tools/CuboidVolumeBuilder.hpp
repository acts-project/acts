...
//~ ///
//~ /// A volume builder to be used for building a concentrical cylindrical
//volumes
//~ ///  - a) configured volume
//~ ///  - b) wrapping around a cylindrical/disk layer config
//~ ///
//~ /// All are optionally wrapped around a given volume which has to by a
//cylinder
//~ /// volume and which has to be center at z == 0
//~ ///
//~ ///  To receive the tracking volume it is possible to also hand over a
//triple of
//~ /// layers, which is a C++ tuple of three pointers to layer vectors (defined
//in
...
//~ /// represents the layers of the negative endcap, the second the layers of
//the
//~ /// barrel and the third the layers of the positive endcap. If the one of
//these
