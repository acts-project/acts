...
namespace Acts {
  ...
  inline const float&
  SpacePointData::quality(std::size_t idx) const
  { return m_quality[idx];  }

  inline const float&
  SpacePointData::deltaR(std::size_t idx) const
  { return m_deltaR[idx]; }  
  ...
  inline void
  SpacePointData::reserve(std::size_t n)
  {
    m_quality.reserve(n);
    m_deltaR.reserve(n);
  }
  ...
  inline void
  SpacePointData::resize(std::size_t n)
  {
