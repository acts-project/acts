...
class GenericFreeTrackParameters {
 public:
  ...
  /// Time coordinate.
  constexpr Scalar time() const { return m_params[eFreeTime]; }

  /// Charge over momentum
  constexpr Scalar phi() const { return phi(direction()); }
  /// Charge over momentum
  constexpr Scalar theta() const { return theta(direction()); }
  /// Charge over momentum
  constexpr Scalar qOverP() const { return m_params[eFreeQOverP]; }
  ...
  /// Transverse momentum.
  constexpr Scalar transverseMomentum() const {
