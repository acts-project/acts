...
#include "Acts/EventData/detail/SpacePointContainerColumn.hpp"
...
class SpacePointContainer {
 public:
  ...
  using MutableProxy = MutableSpacePointProxy;
  /// Type alias for const space point proxy
  using ConstProxy = ConstSpacePointProxy;
  ...
  SpacePointContainer(const SpacePointContainer &other) noexcept;
  ...
  ~SpacePointContainer() noexcept = default;

  /// Assignment operator for copying a space point container.
  /// @param other The space point container to copy.
  /// @return A reference to this space point container.
  SpacePointContainer &operator=(const SpacePointContainer &other) noexcept;
  ...
  void copyFrom(Index index, const SpacePointContainer &otherContainer,
  ...
  MutableColumnProxy<SpacePointIndex> copiedFromIndexColumn() noexcept {
  ...
  ConstColumnProxy<SpacePointIndex> copiedFromIndexColumn() const noexcept {
    assert(m_copiedFromIndexColumn.has_value() &&
           "Column 'copiedFromIndex' does not exist");
    return m_copiedFromIndexColumn->proxy(*this);
  }
  ...
  class Range
      : public Acts::detail::ContainerRange<Range<read_only>, Range<true>,
                                            SpacePointContainer, Index,
                                            read_only> {
   public:
    /// Base class type
    using Base =
        Acts::detail::ContainerRange<Range<read_only>, Range<true>,
                                     SpacePointContainer, Index, read_only>;
  ...
  class Subset : public Acts::detail::ContainerSubset<
                     Subset<read_only>, Subset<true>, SpacePointContainer,
 ...
 private:
  ...
  // copy information
  std::optional<ColumnHolder<SpacePointIndex>> m_copiedFromIndexColumn;
  ...
  void copyColumns(const SpacePointContainer &other);
  void moveColumns(SpacePointContainer &other) noexcept;
