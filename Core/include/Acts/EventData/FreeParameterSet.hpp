...
class FreeParameterSet {
 private:
  ...
  static_assert(detail::are_sorted<true, true, FreeParametersIndices, params...>::value,
 ...
 public:
  ...
  FreeParameterSet(std::optional<CovMatrix_t> cov,
    ...
    detail::initialize_parset<FreeParametersIndices, params...>::init(*this, head, values...);
  }
  ...
  FreeParameterSet(std::optional<CovMatrix_t> cov, const ParVector_t& values)
    ...
    detail::initialize_parset<FreeParametersIndices, params...>::init(*this, values);
  }
  ...
  static constexpr size_t getIndex() {
    return detail::get_position<FreeParametersIndices, parameter, params...>::value;
  }
  ...
  template <FreeParametersIndices parameter>
  bool contains() const {
    return detail::is_contained<FreeParametersIndices, parameter, params...>::value;
  }
