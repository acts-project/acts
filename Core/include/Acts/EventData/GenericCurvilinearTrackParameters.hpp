...
class GenericCurvilinearTrackParameters
 ...
 public:
  ...
  GenericCurvilinearTrackParameters(const Vector4& pos4, const Vector3& dir,
                                    ...
                                    particle_hypothesis_t particleHypothesis)
  ...
  using GenericBoundTrackParameters<particle_hypothesis_t>::direction;
  using GenericBoundTrackParameters<particle_hypothesis_t>::localPosition;
  using GenericBoundTrackParameters<particle_hypothesis_t>::referenceSurface;
  using GenericBoundTrackParameters<particle_hypothesis_t>::fourPosition;
  using GenericBoundTrackParameters<particle_hypothesis_t>::position;

  /// Space-time position four-vector.
  Vector4 fourPosition() const {
    return GenericBoundTrackParameters<particle_hypothesis_t>::fourPosition({});
  }
  /// Spatial position three-vector.
  Vector3 position() const {
    return GenericBoundTrackParameters<particle_hypothesis_t>::position({});
  }
};
