...
class TrackStateProxy {
 public:
  ...
  void setFullProjectorMapping(FullProjectorMapping fullMapping)
    requires(!ReadOnly)
  {
    assert(has<hashString("projector")>());
  ...
  template <std::size_t measdim>
  void setProjectorMapping(ProjectorMapping<measdim> proj)
    requires(!ReadOnly)
  {
    assert(has<hashString("projector")>());
    FullProjectorMapping& fullMapping =
  ...
  void setCalibratedSubspace(std::array<index_t, measdim> subspaceIndices)
    requires(!ReadOnly)
  {
    assert(has<hashString("projector")>());
    FullProjectorMapping& fullMapping =
