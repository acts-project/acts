...
static constexpr long double s_epsilon =
    3 * std::numeric_limits<long double>::epsilon();
...
static constexpr long double s_onSurfaceTolerance = 1e-4;
...
static constexpr long double s_curvilinearProjTolerance = 0.999995;
