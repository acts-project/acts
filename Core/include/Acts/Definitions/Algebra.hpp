...
using ActsVector = Eigen::Matrix<long double, kSize, 1>;

template <unsigned int kRows, unsigned int kCols>
using ActsMatrix = Eigen::Matrix<long double, kRows, kCols>;

template <unsigned int kSize>
using ActsSquareMatrix = Eigen::Matrix<long double, kSize, kSize>;

using ActsDynamicVector = Eigen::Matrix<long double, Eigen::Dynamic, 1>;
...
using Translation2 = Eigen::Translation<long double, 2>;
using Translation3 = Eigen::Translation<long double, 3>;
...
using AngleAxis3 = Eigen::AngleAxis<long double>;
...
using Transform2 = Eigen::Transform<long double, 2, Eigen::AffineCompact>;
using Transform3 = Eigen::Transform<long double, 3, Eigen::Affine>;

constexpr long double s_transformEquivalentTolerance = 1e-9;
