...
std::pair<Eigen::Matrix<BoundScalar, Eigen::Dynamic, Eigen::Dynamic>,
...
globalTrackParametersCovariance(
  ...
  Eigen::Matrix<BoundScalar, Eigen::Dynamic, Eigen::Dynamic>
      fullGlobalTrackParamsCov(nSmoothedStates * eBoundSize,
