...
std::vector<MaybeSharedPtr<Surface>> cylindricalSupport(
...
///
/// @return a vector of surfaces that represent this support
std::vector<MaybeSharedPtr<Surface>> discSupport(
    const SupportSurfaceComponents& components, unsigned int splits = 1u);
...
///
/// @return a vector of surfaces that represent this support
std::vector<MaybeSharedPtr<Surface>> rectangularSupport(
...
void addSupport(std::vector<MaybeSharedPtr<Surface>>& layerSurfaces,
