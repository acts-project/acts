...
inline Acts::BoundaryCheck::Type
Acts::BoundaryCheck::type() const {
  return m_type;
}

inline const Acts::Vector2D&
Acts::BoundaryCheck::tolerance() const {
  return m_tolerance;
}

inline Acts::SymMatrix2D
Acts::BoundaryCheck::covariance() const {
