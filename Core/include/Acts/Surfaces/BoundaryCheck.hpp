...
class BoundaryCheck {
 public:
  ...
  bool isInside(const Vector2& point, const Vector2DContainer& vertices) const;
...
inline bool Acts::BoundaryCheck::isInside(
    const Vector2& point, const Vector2DContainer& vertices) const {
...
inline double Acts::BoundaryCheck::distance(
    const Acts::Vector2& point, const Vector2DContainer& vertices) const {
