...
std::vector<double> phiSegments(double phiMin = -std::numbers::pi_v<double>,
                                double phiMax = std::numbers::pi_v<double>,
...
std::vector<Vector2> ellipsoidVertices(
    ...
    double avgPhi = 0., double halfPhi = std::numbers::pi_v<double>,
    unsigned int quarterSegments = 2u);
...
std::vector<Vector2> circularVertices(
    ...
    double halfPhi = std::numbers::pi_v<double>,
    unsigned int quarterSegments = 2u);
