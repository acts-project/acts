...
struct LinearizedTrack {
  ...
  LinearizedTrack(const BoundVector& paramsAtPCA,
                  ...
                  const Eigen::Matrix<BoundScalar, eBoundSize, 4>& posJacobian,
                  const Eigen::Matrix<BoundScalar, eBoundSize, 3>& momJacobian,
  ...
  Eigen::Matrix<BoundScalar, eBoundSize, 4> positionJacobian{
      Eigen::Matrix<BoundScalar, eBoundSize, 4>::Zero()};
  Eigen::Matrix<BoundScalar, eBoundSize, 3> momentumJacobian{
      Eigen::Matrix<BoundScalar, eBoundSize, 3>::Zero()};
