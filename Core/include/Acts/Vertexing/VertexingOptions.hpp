...
struct VertexingOptions {
  VertexingOptions() = default;

  /// VertexingOptions with vertex constraint
  ///
  ...
  VertexingOptions(const Vertex& constr, const bool useConstr = true)
      : constraint(constr), useConstraintInFit(useConstr) {
