...
//~ #pragma once
//~ #include "Acts/Propagator/StepperExtension.hpp"

//~ namespace Acts {

//~ /// @brief Actor as configurator of the Stepper for working with material
//~ /// interaction. It sets up a tracking of the material and the particles
//mass
...
//~
//state.stepping.extension.get<detail::DenseEnvironmentExtension>().momentumCutOff
//= m_momentumCutOff;
