...
class MultiEigenStepperLoop
 ...
 public:
  ...
  using BoundState =
      std::tuple<MultiComponentBoundTrackParameters<SinglyCharged>, Jacobian,
                 ActsScalar>;

  /// @brief Define an own curvilinear state
  using CurvilinearState =
      std::tuple<MultiComponentCurvilinearTrackParameters<SinglyCharged>,
                 Jacobian, ActsScalar>;
  ...
  struct State {
    ...
    explicit State(
        ...
        : geoContext(gctx), magContext(mctx) {
