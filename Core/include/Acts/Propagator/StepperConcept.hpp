...
// clang-format off
template <typename S>
constexpr bool SingleStepperStateConcept = require<
...
struct CommonStepperConcept {
  ...
  template <typename T> using curvilinear_state_t = typename T::CurvilinearState;
  ...
  constexpr static bool covariance_transport_exists = require<
    has_method<const S, void, covariance_transport_curvilinear_t, state&>,
...
struct SingleStepperConcept {
  ...
  constexpr static bool update_method_exists = require<
    has_method<const S, void, update_t, state&, const FreeVector&, const BoundVector&, const BoundSymMatrix&, const Surface&>,
...
// Method trait for the step member-function, needed by the propagator
...
constexpr bool StepperStateConcept =
    Acts::Concepts::Stepper::SingleStepperStateConcept<stepper> ||
