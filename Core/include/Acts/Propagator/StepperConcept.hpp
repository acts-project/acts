...
// clang-format off
    template <typename S, typename state = typename S::State>
      struct CommonStepperConcept {
        ...
        constexpr static bool bound_state_method_exists= has_method<const S, Result<typename S::BoundState>, bound_state_method_t, state&, const Surface&, bool, const detail::FreeToBoundCorrection&>;
        ...
        constexpr static bool covariance_transport_exists = require<has_method<const S, void, covariance_transport_curvilinear_t, state&>,
                                                                    has_method<const S, void, covariance_transport_bound_t, state&, const Surface&, const detail::FreeToBoundCorrection&>>;
