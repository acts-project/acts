...
struct DenseMaterialInteractor {
  ...
  /// Main function for the recording and evaluation of the scattering contribution
  ///
  ...
  void operator()(propagator_state_t& state, const stepper_t& stepper,
	...
	{
		// If it was a dense environment, the contributions will be evaluated and applied
		if(result.s != 0.)
		{
 ...
 private:
  ...
  /// @param [in, out] result Storage of scattering contribution variables
  ///
  /// @return Matrix containing the additivie contributions to the covariance matrix
