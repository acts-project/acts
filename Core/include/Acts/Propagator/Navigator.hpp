...
class Navigator {
 public:
  ...
  void handleSurfaceStatus(State& state, const Vector3& position,
    ...
    ACTS_VERBOSE(volInfo(state) << "Entering Navigator::handleSurfaceStatus.");
