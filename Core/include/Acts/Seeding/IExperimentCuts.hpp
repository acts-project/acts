...
class IExperimentCuts {
 public:
  ...
  virtual float seedWeight(
      const InternalSpacePoint<external_spacepoint_t>& bottom,
      const InternalSpacePoint<external_spacepoint_t>& middle,
      const InternalSpacePoint<external_spacepoint_t>& top) const = 0;
  ...
  virtual bool singleSeedCut(
      float weight, const InternalSpacePoint<external_spacepoint_t>& bottom,
      const InternalSpacePoint<external_spacepoint_t>& middle,
      const InternalSpacePoint<external_spacepoint_t>& top) const = 0;
