...
enum class SpacePointCandidateTypeNA60 : short { eBottom, eTop };

enum class DetectorMeasurementInfoNA60 : short { eDefault, eDetailed };

template <typename external_spacepoint_t, typename grid_t,
          typename platform_t = void*>
class SeedFinderNA60 {
  ///////////////////////////////////////////////////////////////////
  // Public methods:
  ///////////////////////////////////////////////////////////////////
 ...
 public:
  ...
  /// @param config the configuration for the SeedFinderNA60
  SeedFinderNA60(const Acts::SeedFinderConfigNA60<external_spacepoint_t>& config);
  ~SeedFinderNA60() = default;
  /**    @name Disallow default instantiation, copy, assignment */
  //@{
  SeedFinderNA60() = default;
  SeedFinderNA60(const SeedFinderNA60<external_spacepoint_t, grid_t, platform_t>&) = delete;
  SeedFinderNA60<external_spacepoint_t ,grid_t, platform_t>& operator=(
      const SeedFinderNA60<external_spacepoint_t, grid_t, platform_t>&) = default;
  //@}
  ...
  /// @param yMiddleSPRange range object containing the minimum and maximum r for middle SP for a certain z bin.
 ...
 private:
  ...
  /// @param deltaYMinSP minimum allowed r-distance between dublet components
  /// @param deltaYMaxSP maximum allowed r-distance between dublet components
 ...
 private:
  Acts::SeedFinderConfigNA60<external_spacepoint_t> m_config;
};

}  // namespace Acts

#ifndef DOXYGEN
#include "Acts/Seeding/SeedFinderNA60.ipp"
#endif
