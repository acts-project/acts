...
class SeedFilterNA60 {
 public:
  SeedFilterNA60(SeedFilterConfigNA60 config,
             IExperimentCuts<external_spacepoint_t>* expCuts = nullptr);

  SeedFilterNA60() = delete;
  virtual ~SeedFilterNA60() = default;
