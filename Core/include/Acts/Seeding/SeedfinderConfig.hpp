...
/// @brief Configuration struct for the SeedFinder, it is templated
// on the space point type
...
struct SeedFinderConfig {
  ...
  /// Impact parameter
  float impactMax = 20_mm;

  /// How many sigmas of scattering angle should be considered?
  float sigmaScattering = 5;

  /// How many seeds can one SpacePoint be the middle SpacePoint?
  ...
  float collisionRegionMin = -150_mm;
  float collisionRegionMax = +150_mm;
  //
  float phiMin = -M_PI;
  float phiMax = M_PI;
