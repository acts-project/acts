...
Acts::future::BinnedSPGroupIterator<external_spacepoint_t>::BinnedSPGroupIterator(
										 Acts::future::BinnedSPGroup<external_spacepoint_t>& group,
...
template <typename external_spacepoint_t>
inline Acts::future::BinnedSPGroupIterator<external_spacepoint_t>&
Acts::future::BinnedSPGroupIterator<external_spacepoint_t>::operator++() {
  ++m_gridItr;
  findNotEmptyBin();
  return *this;
}
...
template <typename external_spacepoint_t>
inline bool Acts::future::BinnedSPGroupIterator<external_spacepoint_t>::operator==(
										   const Acts::future::BinnedSPGroupIterator<external_spacepoint_t>& other) const {
...
Acts::future::BinnedSPGroupIterator<external_spacepoint_t>::operator*() const {
  // Global Index
...
template <typename external_spacepoint_t>
inline void
Acts::future::BinnedSPGroupIterator<external_spacepoint_t>::findNotEmptyBin() {
...
Acts::future::BinnedSPGroup<external_spacepoint_t>::BinnedSPGroup(
...
template <typename external_spacepoint_t>
inline std::size_t Acts::future::BinnedSPGroup<external_spacepoint_t>::size() const {
  return m_grid->size();
}

template <typename external_spacepoint_t>
inline Acts::future::BinnedSPGroupIterator<external_spacepoint_t>
Acts::future::BinnedSPGroup<external_spacepoint_t>::begin() {
  return {*this, {0ul, 0ul}, m_bins};
}

template <typename external_spacepoint_t>
inline Acts::future::BinnedSPGroupIterator<external_spacepoint_t>
Acts::future::BinnedSPGroup<external_spacepoint_t>::end() {
