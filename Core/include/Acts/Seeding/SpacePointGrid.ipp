...
std::unique_ptr<Acts::SpacePointGrid<SpacePoint> > Acts::SpacePointGridCreator::createGrid(const Acts::SpacePointGridConfig& config)
{
  ...
  return std::make_unique<Acts::SpacePointGrid<SpacePoint> >(std::make_tuple(phiAxis, zAxis));
}
