...
namespace Acts{
    ...
    template<std::size_t K> class CombinatoricIndices{
        public:
            /// Declare other combinatoric indices classes as friends
           template <std::size_t L>  friend class CombinatoricIndices;
        ...
        /// The number of possiblities to draw K different inidces from the set
        ...
        private:
            ...
            using SubDrawer_t = std::conditional_t<s_hasSubDraw, CombinatoricIndices<K-1>, std::size_t>;
