...
struct grid_helper_impl {
  ...
  static void getBinCenter(
      std::array<long double, sizeof...(Axes)>& center,
  ...
  static void getLowerLeftBinEdge(
      std::array<long double, sizeof...(Axes)>& llEdge,
      const std::array<std::size_t, sizeof...(Axes)>& localIndices,
      const std::tuple<Axes...>& axes) {
  ...
  static void getUpperRightBinEdge(
      std::array<long double, sizeof...(Axes)>& urEdge,
      const std::array<std::size_t, sizeof...(Axes)>& localIndices,
      const std::tuple<Axes...>& axes) {
  ...
  static void getMin(const std::tuple<Axes...>& axes,
                     std::array<long double, sizeof...(Axes)>& minArray) {
  ...
  static void getMax(const std::tuple<Axes...>& axes,
                     std::array<long double, sizeof...(Axes)>& maxArray) {
  ...
  static void getWidth(const std::tuple<Axes...>& axes,
                       std::array<long double, sizeof...(Axes)>& widthArray) {
...
struct grid_helper {
  ...
  ///      under-/overflow bins).
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getBinCenter(
      const std::array<std::size_t, sizeof...(Axes)>& localIndices,
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> center{};
  ...
  ///      underflow bins).
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getLowerLeftBinEdge(
      const std::array<std::size_t, sizeof...(Axes)>& localIndices,
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> llEdge{};
    constexpr std::size_t MAX = sizeof...(Axes) - 1;
  ...
  ///      overflow bins).
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getUpperRightBinEdge(
      const std::array<std::size_t, sizeof...(Axes)>& localIndices,
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> urEdge{};
    constexpr std::size_t MAX = sizeof...(Axes) - 1;
  ...
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getMin(
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> minArray{};
  ...
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getMax(
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> maxArray{};
  ...
  /// @return array returning the maxima of all given axes
  template <class... Axes>
  static std::array<long double, sizeof...(Axes)> getWidth(
      const std::tuple<Axes...>& axes) {
    std::array<long double, sizeof...(Axes)> widthArray{};
