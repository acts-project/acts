...
class PortalPlacement final : public SurfacePlacementBase {
 public:
  ///  Allow the VolumePlacementBase as only class to construct
  ...
  ///  Returns the const reference to portal surface connected with
  ///        this placement instance
  const RegularSurface& surface() const override;

  ///  Returns the mutable reference to portal surface connected with
  ///        this placement instance
  ...
  ///  Returns the transform from the portal to the
