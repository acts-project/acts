...
Acts::SurfacePtrsContainer Acts::SurfaceContainer::getPtrs(DetectorPtr detector) const{
...
Acts::SurfacePtrsContainer Acts::SurfaceContainer::getPtrs(TrackingGeometryPtr tGeometryPtr) const{
    Acts::SurfaceContainer::SurfaceVisitor visitor;
