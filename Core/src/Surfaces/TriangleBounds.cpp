...
Acts::TriangleBounds::TriangleBounds()
  : Acts::PlanarBounds(), m_boundValues(TriangleBounds::bv_length, 0.)
{
}
...
Acts::TriangleBounds::TriangleBounds(const Acts::Vector2D& p1,
                                     const Acts::Vector2D& p2,
                                     const Acts::Vector2D& p3)
  : Acts::PlanarBounds(), m_boundValues(TriangleBounds::bv_length, 0.)
{
...
Acts::TriangleBounds::TriangleBounds(const TriangleBounds& tribo)
  : Acts::PlanarBounds(), m_boundValues(tribo.m_boundValues)
{
}
...
{
  if (this != &tribo) m_boundValues = tribo.m_boundValues;
  return *this;
}

bool
Acts::TriangleBounds::operator==(const Acts::SurfaceBounds& sbo) const
{
  // check the type first not to compare apples with oranges
  const Acts::TriangleBounds* tribo
      = dynamic_cast<const Acts::TriangleBounds*>(&sbo);
  if (!tribo) return false;
  return (m_boundValues == tribo->m_boundValues);
}

double
Acts::TriangleBounds::minDistance(const Acts::Vector2D& pos) const
{
  const int Np = 3;
...
Acts::TriangleBounds::dump(std::ostream& sl) const
{
  ...
  sl << "(" << m_boundValues.at(TriangleBounds::bv_x1) << " , "
     << m_boundValues.at(TriangleBounds::bv_y1) << ") " << '\n';
  sl << "(" << m_boundValues.at(TriangleBounds::bv_x2) << " , "
     << m_boundValues.at(TriangleBounds::bv_y2) << ") " << '\n';
  sl << "(" << m_boundValues.at(TriangleBounds::bv_x3) << " , "
     << m_boundValues.at(TriangleBounds::bv_y3) << ") ";
