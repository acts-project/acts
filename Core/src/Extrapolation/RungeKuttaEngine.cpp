...
/////////////////////////////////////////////////////////////////////////////////
// RungeKuttaEngine.cpp, ACTS project
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
void
Acts::RungeKuttaEngine::setConfiguration(
    const Acts::RungeKuttaEngine::Config& rkConfig)
{
...
Acts::RungeKuttaEngine::propagate(ExCellNeutral&           eCell,
                                  const Surface&           sf,
                                  PropDirection            pDir,
                                  ...
                                  bool returnCurvilinear) const
{
  ...
  bool finalPropagation = (eCell.endSurface == (&sf)
                           && purpose == ExtrapolationMode::Destination);
  ...
  if (nParameters) {
    ...
    if (pDir != anyDirection
      ...
      if (eCell.checkConfigurationMode(
              Acts::ExtrapolationMode::CollectJacobians))
...
/////////////////////////////////////////////////////////////////////////////////
Acts::ExtrapolationCode
Acts::RungeKuttaEngine::propagate(ExCellCharged&           eCell,
                                  const Surface&           sf,
                                  PropDirection            pDir,
                                  ExtrapolationMode::eMode purpose,
                                  const BoundaryCheck&     bcheck,
...
/////////////////////////////////////////////////////////////////////////////////
bool
Acts::RungeKuttaEngine::propagateWithJacobian(int               navigationStep,
                                              PropagationCache& pCache,
                                              int               kind,
                                              double*           Su) const
{
...
/////////////////////////////////////////////////////////////////////////////////
double
Acts::RungeKuttaEngine::rungeKuttaStep(int               navigationStep,
                                       PropagationCache& pCache,
                                       double            S,
                                       bool&             InS) const
{
...
/////////////////////////////////////////////////////////////////////////////////
double
Acts::RungeKuttaEngine::rungeKuttaStepWithGradient(int navigationStep,
                                                   PropagationCache& pCache,
                                                   double            S,
                                                   bool&             InS) const
{
...
/////////////////////////////////////////////////////////////////////////////////
bool
Acts::RungeKuttaEngine::newCrossPoint(const CylinderSurface& Su,
                                      const double*          Ro,
...
/////////////////////////////////////////////////////////////////////////////////
double
Acts::RungeKuttaEngine::straightLineStep(int               navigationStep,
                                         PropagationCache& pCache,
                                         double            S) const
{
  EX_MSG_VERBOSE(
...
Acts::RungeKuttaEngine::buildTrackParametersWithoutPropagation(
...
Acts::RungeKuttaEngine::buildNeutralParametersWithoutPropagation(
...
/////////////////////////////////////////////////////////////////////////////////
double
Acts::RungeKuttaEngine::stepEstimatorWithCurvature(PropagationCache& pCache,
                                                   int               kind,
                                                   double*           Su,
                                                   bool&             Q) const
{
