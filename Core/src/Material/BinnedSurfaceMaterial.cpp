///////////////////////////////////////////////////////////////////
// BinnedSurfaceMaterial.cxx, ACTS project
///////////////////////////////////////////////////////////////////
...
Acts::BinnedSurfaceMaterial::BinnedSurfaceMaterial(const Acts::BinUtility& binutility,
...
Acts::BinnedSurfaceMaterial::BinnedSurfaceMaterial( const Acts::BinnedSurfaceMaterial& lmp) :
Acts::SurfaceMaterial(lmp),
...
Acts::BinnedSurfaceMaterial& Acts::BinnedSurfaceMaterial::operator=(const Acts::BinnedSurfaceMaterial& lmp)
{
    if (this!=&lmp) {
...
Acts::BinnedSurfaceMaterial* Acts::BinnedSurfaceMaterial::clone() const
{
    return new Acts::BinnedSurfaceMaterial(*this);
}

void Acts::BinnedSurfaceMaterial::clearMaterial()
{
...
void Acts::BinnedSurfaceMaterial::fillMaterial(const Acts::MaterialPropertiesMatrix& matMatrix)
{
...
const Acts::MaterialProperties* Acts::BinnedSurfaceMaterial::material(const Acts::Vector2D& lp) const
{
...
const Acts::MaterialProperties* Acts::BinnedSurfaceMaterial::material(const Acts::Vector3D& gp) const
{
    if (!m_fullMaterial.size() || !m_binUtility ) return nullptr;
    // the first bin
...
std::ostream& Acts::BinnedSurfaceMaterial::dump( std::ostream& sl) const
{
