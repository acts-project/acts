...
auto Acts::materialMapperRZ(
    ...
    -> MaterialMapper<detail::Grid<Vector<float, 5>, detail::EquidistantAxis,
                                   detail::EquidistantAxis>> {
  // [1] Decompose material
  std::vector<Vector<float, 5>> materialVector;
  ...
  // Create the grid
  using Grid_t = detail::Grid<Vector<float, 5>, detail::EquidistantAxis,
                              detail::EquidistantAxis>;
  ...
  return MaterialMapper<detail::Grid<Vector<float, 5>, detail::EquidistantAxis,
...
auto Acts::materialMapperXYZ(
    ...
    -> MaterialMapper<
        detail::Grid<Vector<float, 5>, detail::EquidistantAxis,
