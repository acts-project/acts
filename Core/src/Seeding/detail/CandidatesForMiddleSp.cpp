...
CandidatesForMiddleSp::CandidatesForMiddleSp()
    : CandidatesForMiddleSp(kNoSize, kNoSize) {}

CandidatesForMiddleSp::CandidatesForMiddleSp(Size nLow, Size nHigh)
...
void CandidatesForMiddleSp::toSortedCandidates(
    std::vector<TripletCandidate>& output) {
  output.clear();
  output.reserve(size());
