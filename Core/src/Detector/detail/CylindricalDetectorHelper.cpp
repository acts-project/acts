...
void checkVolumes(
  ...
  Acts::Experimental::detail::ConsistencyChecker::checkRotationAlignment(
      gctx, volumes);
}
...
Acts::Experimental::detail::CylindricalDetectorHelper::connectInR(
  ...
  auto sideVolumes = PortalHelper::stripSideVolumes(
      containers, {0u, 1u, 4u, 5u}, selectedOnly);
...
Acts::Experimental::detail::CylindricalDetectorHelper::connectInZ(
  ...
  auto sideVolumes =
      PortalHelper::stripSideVolumes(containers, nominalSides, selectedOnly);
...
Acts::Experimental::detail::CylindricalDetectorHelper::wrapInZR(
  ...
  if (innerContainer.size() == 4u and
    ...
    auto sideVolumes =
        PortalHelper::stripSideVolumes({innerContainer}, {3u}, {3u});
