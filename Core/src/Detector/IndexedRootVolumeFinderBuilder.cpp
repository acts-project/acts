    ...
    if (ic0 > 0) {
      ...
      for (const auto [ic1, c1] : Acts::enumerate(boundaries[1u])) {
        if (ic1 > 0) {
          ...
          if (casts ==
              std::array<Acts::BinningValue, 2u>{Acts::BinningValue::binZ, Acts::BinningValue::binR}) {
...
Acts::Experimental::IndexedRootVolumeFinderBuilder::
  ...
  if (m_casts != std::vector<Acts::BinningValue>{Acts::BinningValue::binZ, Acts::BinningValue::binR}) {
