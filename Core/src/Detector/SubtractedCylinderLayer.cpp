...
Acts::SubtractedCylinderLayer::SubtractedCylinderLayer(
    const Acts::SubtractedCylinderSurface* subCyl,
    double                                 thickness,
    int                                    laytyp)
...
Acts::SubtractedCylinderLayer::SubtractedCylinderLayer(
    const Acts::SubtractedCylinderLayer& clay,
    const Acts::Transform3D&             transf)
  : SubtractedCylinderSurface(clay, transf), Layer(clay)
{
}

const Acts::SubtractedCylinderSurface&
Acts::SubtractedCylinderLayer::surfaceRepresentation() const
{
  return (*this);
}
