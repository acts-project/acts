...
Acts::DigitizationModule::segmentationSurfaces(const Acts::DigitizationCell& entryCids, 
...
const Acts::SurfacePtrVector 
Acts::DigitizationModule::stepSurfaces(const Vector3D& start, const Vector3D& end) const 
{
