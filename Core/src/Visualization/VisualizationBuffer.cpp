...
namespace Acts {
  ...
  void VisualizationBuffer::line(const Vector3& a, const Vector3& b, Color color)
    {
  ...
  void VisualizationBuffer::line(const Vector3& a, const Vector3& b,  const double lineThickness,
            Color color)
    {
      m_linecolors.push_back(color);
  ...
  void VisualizationBuffer::face(const std::vector<Vector3>& vtxs,
            Color color) {}
