...
void
Acts::IVisualization::vertex(const Vector3F& vtx, ColorRGB color) {
...
bool
Acts::IVisualization::hasExtension(const std::string& path) const {
  return (path.find(".") != std::string::npos);
}

void
Acts::IVisualization::replaceExtension(std::string& path,
