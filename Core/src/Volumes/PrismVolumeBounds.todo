...
Acts::PrismVolumeBounds::PrismVolumeBounds()
  : VolumeBounds(), m_halfZ(), m_baseBounds(0), m_ordering(-1)
{
}
...
Acts::PrismVolumeBounds::PrismVolumeBounds(
    ...
    float halez)
  : VolumeBounds(), m_halfZ(halez), m_baseBounds(0), m_ordering(-1)
{
    ...
    std::shared_ptr<Acts::Transform3D> transformPtr) const
{
  ...
  Acts::PlaneSurface* xyPlane
      = new Acts::PlaneSurface(std::shared_ptr<Acts::Transform3D>(tTransform),
                               new Acts::TriangleBounds(m_xyVtx));
  retsf->push_back(xyPlane);
  //  (2) - at negative local z
  tTransform = new Acts::Transform3D(
      transform * Acts::Translation3D(Acts::Vector3D(0., 0., -m_halfZ))
      * Acts::AngleAxis3D(M_PI, Acts::Vector3D(1., 0., 0.)));
  Acts::PlaneSurface* xymPlane
      = new Acts::PlaneSurface(std::shared_ptr<Acts::Transform3D>(tTransform),
                               new Acts::TriangleBounds(mirror_xyVtx()));
...
// faces in xy
Acts::PlaneSurface*
Acts::PrismVolumeBounds::sideSurf(Acts::Transform3D transform,
                                  unsigned int      iv1,
                                  unsigned int      iv2) const
{
  ...
  Acts::Transform3D* tTransform = new Acts::Transform3D(
      ...
      * Acts::AngleAxis3D(-ori * 0.5 * M_PI, Acts::Vector3D(1., 0., 0.)));
  plane
      = new Acts::PlaneSurface(std::shared_ptr<Acts::Transform3D>(tTransform),
  ...
  if (d.dot(plane->normal()) > 0.) {
    ...
    tTransform = new Acts::Transform3D(
        transform * Acts::Translation3D(pos)
        * Acts::AngleAxis3D(phi + M_PI, Acts::Vector3D(0., 0., 1.))
        * Acts::AngleAxis3D(-ori * 0.5 * M_PI, Acts::Vector3D(1., 0., 0.)));
    plane = new Acts::PlaneSurface(
...
bool
Acts::PrismVolumeBounds::inside(const Acts::Vector3D& pos, double tol) const
{
...
Acts::PrismVolumeBounds::mirror_xyVtx() const
{
...
int
Acts::PrismVolumeBounds::ordering() const
{
...
std::ostream&
Acts::PrismVolumeBounds::dump(std::ostream& sl) const
{
