...
{
  return new Acts::DiamondBounds(m_valueStore.at(bv_minHalfX),
...
{
  return new Acts::RectangleBounds(m_valueStore.at(bv_halfY1)
...
{
  return new Acts::RectangleBounds(m_valueStore.at(bv_halfY2)
