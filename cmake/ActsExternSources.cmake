set(ACTS_ACTSVG_SOURCE
    "URL;https://github.com/acts-project/actsvg/archive/refs/tags/v0.4.40.tar.gz;URL_MD5;c8f3a7ac47db7f39cd4f215a5bbf148d"
    CACHE STRING
...
set(ACTS_TRACCC_SOURCE
    "URL;https://github.com/acts-project/traccc/archive/refs/tags/v0.13.0.tar.gz;URL_MD5;1ddf757ddcbaa08fd7db3a7752ef7f98"
    CACHE STRING
...
set(ACTS_GEOMODEL_SOURCE
    "GIT_REPOSITORY;https://gitlab.cern.ch/GeoModelDev/GeoModel;GIT_TAG;4.6.0;"
    CACHE STRING
    "Source to take GeoModel from"
)
mark_as_advanced(ACTS_GEOMODEL_SOURCE)

set(ACTS_NLOHMANNJSON_SOURCE
    "URL;https://github.com/nlohmann/json/archive/refs/tags/v3.10.5.tar.gz;URL_HASH;SHA1=8969f5ad1a422e01f040ff48dcae9c0e6ad0811d"
    CACHE STRING
...
string(
    ...
    "."
    "_"
    _acts_boost_recommended_version_
    ${_acts_boost_recommended_version}
)
set(ACTS_BOOST_SOURCE
    "URL;https://boostorg.jfrog.io/artifactory/main/release/${_acts_boost_recommended_version}/source/boost_${_acts_boost_recommended_version_}.tar.gz"
    CACHE STRING
    "Source to take boost from"
)
mark_as_advanced(ACTS_BOOST_SOURCE)

set(ACTS_EIGEN3_SOURCE
    "URL;https://gitlab.com/libeigen/eigen/-/archive/${_acts_eigen3_version}/${_acts_eigen3_version}.tar.gz"
    CACHE STRING
