...
int main(int argc, char* argv[]) {
  ...
  // setup particle reader from simulated input
  ...
  vertexWriterConfig.inputAllTruthParticles =
      readParticles.outputParticles;
  vertexWriterConfig.inputSelectedTruthParticles = selectParticles.outputParticles;
  vertexWriterConfig.inputAssociatedTruthParticles =
      selectParticles.outputParticles;
  vertexWriterConfig.inputFittedTracks = smearParticles.outputTrackParameters;
