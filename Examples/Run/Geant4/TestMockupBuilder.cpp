...
int main(){
	...
	auto detectorVolume_inner_chamber = mockup_builder.BuildChamber(
		gctx, mockup_chamberConfig_inner);

	auto detectorVolume_middle_chamber = mockup_builder.BuildChamber(
		gctx, mockup_chamberConfig_middle);

	auto detectorVolume_outer_chamber = mockup_builder.BuildChamber(
		gctx, mockup_chamberConfig_outer);
	...
	auto detectorVolume_sector = mockup_builder.BuildSector(detector_volumes, gctx);
