...
try:
    subprocess.check_call(
        [sys.executable, "-c", "from acts.plugins.ActsPluginsPythonBindingsGeant4 import *"]
    )
except subprocess.CalledProcessError as e:
    print("Error encountered importing Geant4 as a plugin. Did you build with ACTS_BUILD_PLUGIN_GEANT4=ON ?")
    sys.exit(1)
