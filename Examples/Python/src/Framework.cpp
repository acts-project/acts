...
void addFramework(Context& ctx) {
  ...
  ACTS_PYTHON_STRUCT(c, skip, events, logLevel, numThreads, maxInFlightRange,
                     inFlightSyncTimeoutSeconds, outputDir, outputTimingFile,
                     trackFpes, fpeMasks, failOnFirstFpe, fpeStackTraceLength);
