...
struct HepMC3Event {
 public:
  ...
  void
  lengthUnit(std::shared_ptr<HepMC3::GenEvent> event, const double lengthUnit);
  ...
  /// @param time new time of the event
  void
  shiftPositionTo(std::shared_ptr<HepMC3::GenEvent> event, const double time);
  ...
  double
  momentumUnit(const std::shared_ptr<HepMC3::GenEvent> event);

  /// @brief Getter of the unit of length used
  /// @param event event in HepMC data type
  /// @return unit of length
  double
  lengthUnit(const std::shared_ptr<HepMC3::GenEvent> event);

  /// @brief Getter of the position of the event
  /// @param event event in HepMC data type
  /// @return vector to the location of the event
  Acts::Vector3D
  eventPos(const std::shared_ptr<HepMC3::GenEvent> event);

  /// @brief Getter of the time of the event
  /// @param event event in HepMC data type
  /// @return time of the event
  double
  eventTime(const std::shared_ptr<HepMC3::GenEvent> event);
