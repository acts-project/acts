...
TrackContainerToPodioConverter::TrackContainerToPodioConverter(
    const Config& config,
    std::shared_ptr<ActsPlugins::PodioUtil::ConversionHelper> helper,
    Acts::Logging::Level level)
    : PodioOutputConverter("TrackContainerToPodioConverter", level),
      m_cfg(config),
...
ActsExamples::ProcessCode TrackContainerToPodioConverter::execute(
...
std::vector<std::string> TrackContainerToPodioConverter::collections() const {
