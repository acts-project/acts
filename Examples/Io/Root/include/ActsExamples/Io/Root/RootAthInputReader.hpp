...
class RootAthInputReader : public IReader {
    ...
    private:
        ...
        // Tree structure
        int m_nSP;
        std::vector<int>   *m_SPindex = nullptr;
        std::vector<float> *m_SPx = nullptr;
        std::vector<float> *m_SPy = nullptr;
        std::vector<float> *m_SPz = nullptr;
        std::vector<int>   *m_SPCL1_index = nullptr;
        std::vector<int>   *m_SPCL2_index = nullptr;
