...
from FatrasExtrapolationEngine import FatrasExtrapolationEngine
ExtrapolationEngine = FatrasExtrapolationEngine(name='Extrapolation', nameprefix='Fatras', ToolOutputLevel=ExToolOutputLevel, TrackingGeometrySvc=GenericDetector.trackingGeometrySvc())
