...
using identifier_type = ::ActsExamples::SimIdentifier::Value;
using identifier_diff = ::ActsExamples::SimIdentifier::Difference;
using Identifier = ::ActsExamples::SimIdentifier;
