...
namespace ActsExamples {
  class MuonSegment {
      public:
        ...
        const Acts::Vector3& globalPosition() const {
          return m_globPos;
        }
        /** @brief Returns the reconstructed segment direction in global coordinates */
        const Acts::Vector3& globalDirection() const {
          return m_globDir;
        }
