 ...
 public:
  ...
  class MuonId {
   public:
    ...
    enum class TechField : std::int8t_t {
      UnDef = -1,
      Mdt = 0,
      Rpc = 2,
      Tgc = 3,
    ...
    enum class StationName : std::int8t_t {
      UnDef = -1,
      BIS,
      BIL,
      BMS,
    ...
    enum class DetSide : std::int8t_t { UnDef = 0, A = 1, C = -1 };
  ...
  const Acts::Vector3& stripPlaneNormal() const { return m_pos; }
