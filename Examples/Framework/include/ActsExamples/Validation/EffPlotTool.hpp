 ...
 public:
  ...
  struct Config {
    std::map<std::string, PlotHelpers::Binning> varBinning = {
        ...
        {"numberOfHits", PlotHelpers::Binning("N", 40, 0, 41)}};      
  };
  ...
  struct Cache {
    ...
    /// Tracking efficiency vs max measurements
    TEfficiency* trackEff_vs_numberOfHits{nullptr};
  ...
  void fill(Cache& cache, const SimParticleState& truthParticle, double deltaR,
            double matchingProbability, bool matched) const;
