...
void ActsExamples::EffPlotTool::fill(Cache& cache,
  ...
  PlotHelpers::fillEff(cache.trackEff_vs_pT, t_pT, matched);
  PlotHelpers::fillEff(cache.trackEff_vs_eta, t_eta, matched);
  PlotHelpers::fillEff(cache.trackEff_vs_phi, t_phi, matched);
