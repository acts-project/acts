...
TrackQualityPlotTool::TrackQualityPlotTool(const Config& cfg,
    ...
    : m_cfg(cfg),
      ...
      m_completenessVsPt("completenessVsPt",
                         "Completeness;pT [GeV/c];Completeness",
                         std::array{m_cfg.varBinning.at("Pt")}, "Completeness"),
      m_completenessVsEta("completenessVsEta", "Completeness;#eta;Completeness",
                          std::array{m_cfg.varBinning.at("Eta")},
                          "Completeness"),
      m_completenessVsPhi("completenessVsPhi", "Completeness;#phi;Completeness",
                          std::array{m_cfg.varBinning.at("Phi")},
                          "Completeness"),
      m_purityVsPt("purityVsPt", "Purity;pT [GeV/c];Purity",
                   std::array{m_cfg.varBinning.at("Pt")}, "Purity"),
      m_purityVsEta("purityVsEta", "Purity;#eta;Purity",
                    std::array{m_cfg.varBinning.at("Eta")}, "Purity"),
      m_purityVsPhi("purityVsPhi", "Purity;#phi;Purity",
