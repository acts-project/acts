...
FakePlotTool::FakePlotTool(const FakePlotTool::Config& cfg,
    ...
    : m_cfg(cfg),
      ...
      m_nRecoVsPt("nRecoTracks_vs_pT", "Number of reconstructed track candidates",
                  std::array{m_cfg.varBinning.at("Pt"),
                             m_cfg.varBinning.at("Num")}),
      m_nTruthMatchedVsPt("nTruthMatchedTracks_vs_pT",
                          "Number of truth-matched track candidates",
                          std::array{m_cfg.varBinning.at("Pt"),
                                     m_cfg.varBinning.at("Num")}),
      m_nFakeVsPt("nFakeTracks_vs_pT", "Number of fake track candidates",
                  std::array{m_cfg.varBinning.at("Pt"),
                             m_cfg.varBinning.at("Num")}),
      m_nRecoVsEta("nRecoTracks_vs_eta",
                   "Number of reconstructed track candidates",
                   std::array{m_cfg.varBinning.at("Eta"),
                              m_cfg.varBinning.at("Num")}),
      m_nTruthMatchedVsEta("nTruthMatchedTracks_vs_eta",
                           "Number of truth-matched track candidates",
                           std::array{m_cfg.varBinning.at("Eta"),
                                      m_cfg.varBinning.at("Num")}),
      m_nFakeVsEta("nFakeTracks_vs_eta", "Number of fake track candidates",
                   std::array{m_cfg.varBinning.at("Eta"),
                              m_cfg.varBinning.at("Num")}),
      m_fakeRatioVsPt("fakeratio_vs_pT",
                      "Tracking fake ratio;pT [GeV/c];Fake ratio",
                      std::array{m_cfg.varBinning.at("Pt")}),
      m_fakeRatioVsEta("fakeratio_vs_eta", "Tracking fake ratio;#eta;Fake ratio",
                       std::array{m_cfg.varBinning.at("Eta")}),
      m_fakeRatioVsPhi("fakeratio_vs_phi", "Tracking fake ratio;#phi;Fake ratio",
