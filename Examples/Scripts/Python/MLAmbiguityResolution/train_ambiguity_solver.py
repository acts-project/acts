...
CKF_files = sorted(glob.glob("odd_output" + "/event000000[0-7][0-9][0-9]-CKFtracks.csv"))
...
CKF_files_test = sorted(glob.glob("odd_output_1000" + "/event000000[8-9][0-9][0-9]-CKFtracks.csv"))
