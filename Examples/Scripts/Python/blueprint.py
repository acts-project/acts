...
pixel = root.addCylinderContainer(direction=acts.AxisDirection.binZ, name="Pixel")
print(repr(pixel))
...
if True:
    ...
    with pixel.CylinderContainer("PixelPosEndcap", acts.AxisDirection.binZ) as ec:
...
if True:
    with pixel.Material() as mat:
        with mat.CylinderContainer(
            direction=acts.AxisDirection.binZ, name="PixelNegEndcap"
        ) as ec:
            ec.attachmentStrategy = acts.CylinderVolumeStack.AttachmentStrategy.Gap
