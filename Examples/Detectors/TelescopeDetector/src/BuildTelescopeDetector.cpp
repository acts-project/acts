...
ActsExamples::buildTelescopeDetector(
  ...
  // This assumes the axis direction is AxisX, AxisY or AxisZ.
  // No reset is necessary in case of AxisZ
  Acts::RotationMatrix3 rotation = Acts::RotationMatrix3::Identity();
  if (aDir == Acts::AxisDirection::AxisX) {
    rotation.col(0) = Acts::Vector3(0, 0, -1);
    rotation.col(1) = Acts::Vector3(0, 1, 0);
    rotation.col(2) = Acts::Vector3(1, 0, 0);
  } else if (aDir == Acts::AxisDirection::AxisY) {
