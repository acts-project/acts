...
class GeoMuonMockupExperiment : public GeoDeDuplicator {
 ...
 private:
  ...
  ///        This will be used for barrel boxes (cuboids) only. In the ACTS chamber 
  ///        frame the Z axis is along the thickness of the chamber, Y along the 
  ///        chamber length (bending direction) and X along the chamber width (tube direction)
  const GeoTrf::Transform3D s_ActsToGeomodelChamberFrame {
    GeoTrf::RotationMatrix3D {
        {0., 0., 1.},
        {1., 0., 0.},
        {0., 1., 0.}
    }   
