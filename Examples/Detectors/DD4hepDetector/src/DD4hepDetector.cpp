...
DD4hepDetectorBase::DD4hepDetectorBase(const Config& cfg)
  ...
  auto logger = Acts::getDefaultLogger("DD4hepConversion", cfg.logLevel);
}
...
std::shared_ptr<Acts::DD4hepFieldAdapter> DD4hepDetectorBase::field() const {
...
std::unique_ptr<dd4hep::Detector> DD4hepDetectorBase::buildDD4hepGeometry(
  ...
  if (cfg.dd4hepLogLevel >= Acts::Logging::Level::WARNING) {
