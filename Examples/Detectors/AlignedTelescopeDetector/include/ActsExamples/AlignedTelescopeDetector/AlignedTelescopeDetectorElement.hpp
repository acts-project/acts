...
class AlignedTelescopeDetectorElement : public Acts::DetectorElementBase {
 public:
  /// @class ContextType
  ...
  AlignedTelescopeDetectorElement(
  ...
  ///  Destructor
  ~AlignedTelescopeDetectorElement() override = default;
...
inline const Acts::Surface& AlignedTelescopeDetectorElement::surface() const {
  return *m_elementSurface;
}

inline double AlignedTelescopeDetectorElement::thickness() const {
  return m_elementThickness;
}

inline const Acts::Transform3& AlignedTelescopeDetectorElement::transform(
    const Acts::GeometryContext& gctx) const {
...
inline const Acts::Transform3& AlignedTelescopeDetectorElement::nominalTransform(
    const Acts::GeometryContext& /*gctx*/) const {
  return *m_elementTransform;
}

inline void AlignedTelescopeDetectorElement::addAlignedTransform(
...
AlignedTelescopeDetectorElement::alignedTransforms() const {
