...
std::unique_ptr<const Acts::TrackingGeometry> buildDetector(
  ...
  // - cylindrical
  Acts::BinUtility pCylinderUtility(10, -1, 1, Acts::closed, Acts::BinningValue::binPhi);
  pCylinderUtility += Acts::BinUtility(10, -1, 1, Acts::open, Acts::BinningValue::binZ);
  ...
  pDiscUtility += Acts::BinUtility(10, -1, 1, Acts::closed, Acts::BinningValue::binPhi);
  auto pDiscMaterial =
      std::make_shared<const Acts::ProtoSurfaceMaterial>(pDiscUtility);
  // - plane
  Acts::BinUtility pPlaneUtility(1, -1, 1, Acts::open, Acts::BinningValue::binX);
  auto pPlaneMaterial =
