...
/// @class F2TelescopeDetectorElement
///
/// This is a lightweight type of detector element,
/// it simply implements the base class.
class F2TelescopeDetectorElement : public Acts::DetectorElementBase {
 public:
  /// @class ContextType
  ...
  ///  Destructor
  ~F2TelescopeDetectorElement() override = default;
...
inline const Acts::Surface& F2TelescopeDetectorElement::surface() const {
  return *m_elementSurface;
}

inline double F2TelescopeDetectorElement::thickness() const {
  return m_elementThickness;
}

inline const Acts::Transform3& F2TelescopeDetectorElement::transform(
    const Acts::GeometryContext& gctx) const {
...
inline const Acts::Transform3& F2TelescopeDetectorElement::nominalTransform(
    const Acts::GeometryContext& /*gctx*/) const {
  return *m_elementTransform;
}

inline void F2TelescopeDetectorElement::addAlignedTransform(
...
F2TelescopeDetectorElement::alignedTransforms() const {
