...
auto ActsExamples::F2Telescope::F2TelescopeDetector::finalize(
  ...
  TrackingGeometryPtr gGeometry = ActsExamples::F2Telescope::buildDetector(
      nominalContext, detectorStore, positions, cfg.offsets, cfg.bounds,
      cfg.thickness, cfg.boundsX, cfg.boundsY, cfg.Type_surf,
      static_cast<ActsExamples::F2Telescope::F2TelescopeSurfaceType>(
          cfg.surfaceType),
