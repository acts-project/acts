...
std::shared_ptr<HepMC3::GenEvent> Pythia8Generator::operator()(
  ...
  //   Acts::Vector4 pos4(genParticle.xProd() * 1_mm, genParticle.yProd() *
  //   1_mm,
  //                      genParticle.zProd() * 1_mm, genParticle.tProd() *
  //                      1_mm);
  ...
  //     HepMC3::HepMC3 primaryVertex.outgoing.insert(particleId);
  //   }
  ...
  //   particle.setDirection(genParticle.px(), genParticle.py(),
  //   genParticle.pz()); particle.setAbsoluteMomentum(
