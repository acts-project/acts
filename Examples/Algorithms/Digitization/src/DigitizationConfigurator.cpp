      ...
      if (!dInputConfig->geometricDigiConfig.indices.empty()) {
        ...
        switch (sBounds.type()) {
          ...
          case Acts::SurfaceBounds::eRectangle: {
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binX) {
              ...
              outputSegmentation +=
                  Acts::BinUtility(nBins, minX, maxX, Acts::open, Acts::BinningValue::binX);
            }
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binY ||
              ...
              outputSegmentation +=
                  Acts::BinUtility(nBins, minY, maxY, Acts::open, Acts::BinningValue::binY);
            }
          } break;
          ...
          case Acts::SurfaceBounds::eTrapezoid: {
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binX) {
              ...
              outputSegmentation +=
                  Acts::BinUtility(nBins, -maxX, maxX, Acts::open, Acts::BinningValue::binX);
            }
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binY ||
                inputSegmentation.dimensions() == 2) {
              unsigned int accessBin =
              ...
              unsigned int nBins = static_cast<unsigned int>(
                  std::round((2 * maxY) /
                             inputSegmentation.binningData()[accessBin].step));
              outputSegmentation +=
                  Acts::BinUtility(nBins, -maxY, maxY, Acts::open, Acts::BinningValue::binY);
            }
          } break;

          // The module is an annulus module
          case Acts::SurfaceBounds::eAnnulus: {
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binR) {
              ...
              outputSegmentation +=
                  Acts::BinUtility(nBins, minR, maxR, Acts::open, Acts::BinningValue::binR);
            }
            if (inputSegmentation.binningData()[0].binvalue == Acts::BinningValue::binPhi ||
                inputSegmentation.dimensions() == 2) {
              unsigned int accessBin =
                  inputSegmentation.dimensions() == 2 ? 1 : 0;
