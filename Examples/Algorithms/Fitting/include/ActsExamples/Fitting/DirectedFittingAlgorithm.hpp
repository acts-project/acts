...
class DirectedFittingAlgorithm final : public BareAlgorithm {
 public:
  ...
  struct Config {
    ...
    /// Input surface sequence for DirectNavigator
    std::string inputSurfaceSequence;
  ...
  DirectedFittingAlgorithm(Config cfg, Acts::Logging::Level lvl);
