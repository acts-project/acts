  ...
  for (auto&& [vtxId, vtxParticles] : groupBySecondaryVertex(particles)) {
    ...
    for (const auto& particle : vtxParticles) {
      ...
      cov(Acts::eBoundLoc0, Acts::eBoundLoc0) =
          m_cfg.initialVarInflation * sigmaD0 * sigmaD0;
      cov(Acts::eBoundLoc1, Acts::eBoundLoc1) =
          m_cfg.initialVarInflation * sigmaZ0 * sigmaZ0;
      cov(Acts::eBoundTime, Acts::eBoundTime) =
          m_cfg.initialVarInflation * sigmaT0 * sigmaT0;
      cov(Acts::eBoundPhi, Acts::eBoundPhi) =
          m_cfg.initialVarInflation * sigmaPhi * sigmaPhi;
      cov(Acts::eBoundTheta, Acts::eBoundTheta) =
          m_cfg.initialVarInflation * sigmaTheta * sigmaTheta;
      cov(Acts::eBoundQOverP, Acts::eBoundQOverP) =
          m_cfg.initialVarInflation * sigmaQOverP * sigmaQOverP;
