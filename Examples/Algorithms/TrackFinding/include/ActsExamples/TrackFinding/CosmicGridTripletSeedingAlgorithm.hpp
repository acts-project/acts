...
class CosmicGridTripletSeedingAlgorithm final : public IAlgorithm {
 public:
  struct Config {
    ...
    float xMin = -600 * Acts::UnitConstants::mm;
    /// maximum extension of sensitive detector layer relevant for seeding as
    /// distance from x=y=0 (i.e. in r)
    float xMax = 600 * Acts::UnitConstants::mm;
    /// minimum extension of sensitive detector layer relevant for seeding in
    /// negative direction in z
    float yMin = -1000 * Acts::UnitConstants::mm;
    /// maximum extension of sensitive detector layer relevant for seeding as
    /// distance from x=y=0 (i.e. in r)
    float yMax = 1000 * Acts::UnitConstants::mm;
    ...
    float collisionRegionMin = -2500 * Acts::UnitConstants::mm;
    float collisionRegionMax = +2500 * Acts::UnitConstants::mm;
  ...
  explicit CosmicGridTripletSeedingAlgorithm(
 ...
 private:
  Config m_cfg;
  Acts::CartesianSpacePointGrid::Config m_gridConfig;
