 ...
 public:
  struct Config {
    ...
    std::array<double, 6> initialSigmas = {
        10 * Acts::UnitConstants::mm,     10 * Acts::UnitConstants::mm,
        10 * Acts::UnitConstants::degree, 10 * Acts::UnitConstants::degree,
        10 / Acts::UnitConstants::GeV,    10 * Acts::UnitConstants::ns};
