...
class Converter {
 ...
 public:
  ...
  auto createMeasurementConversionData(
    ...
    return Util::createFromIndexMap(tracccMeasurements, measurements, indexMap);
  }
  ...
  template <typename traccc_track_container_t, typename T>
  auto convertTracks(
    ...
    mapMeasurements(tracks, measurementConv);
