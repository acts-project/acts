// stolen from
// https://gitlab.cern.ch/atlas-simulation-team/geant4/-/blob/master/source/physics_lists/lists/src/FTFP_BERT_ATL.cc
...
FTFP_BERT_ATL::FTFP_BERT_ATL(G4int ver) {
  if (ver > 0) {
    G4cout << "<<< Geant4 Physics List simulation engine: FTFP_BERT_ATL"
           << G4endl;
    G4cout << G4endl;
    G4WarnPLStatus exp;
