...
layerBuilderConfigPixel.centralLayerEnvelopes
    = {{0.5, 2.0}, {0.5, 2.0}, {0.5, 2.0}, {0.5, 2.0}, {0.5, 2.0}, {0.5, 2.0}};
layerBuilderConfigPixel.centralLayerMaterialConcentration = {1, 1, 1, 1, 1, 1};
layerBuilderConfigPixel.centralModuleBinningSchema
    = {{13, 25}, {39, 25}, {72, 25}, {104, 25}, {145, 25}, {199, 25}};
layerBuilderConfigPixel.centralModuleTiltPhi
    = {0.18, 0.18, 0.18, 0.18, 0.18, 0.18};
layerBuilderConfigPixel.centralModuleHalfX = {8.3, 8.3, 8.3, 8.3, 8.3, 8.3};
layerBuilderConfigPixel.centralModuleHalfY
    = {16.3, 16.3, 16.3, 16.3, 16.3, 16.3};
layerBuilderConfigPixel.centralModuleThickness
    = {0.15, 0.15, 0.15, 0.15, 0.15, 0.15};
// mPositions
std::vector<std::vector<Vector3D>> centralModulePositions;
for (size_t cl = 0; cl < layerBuilderConfigPixel.centralLayerRadii.size();
     ++cl) {
  // call the helper function
  centralModulePositions.push_back(modulePositionsCylinder(
      layerBuilderConfigPixel.centralLayerRadii[cl],
...
auto layerBuilderPixel = std::make_shared<GenericLayerBuilder>(
    layerBuilderConfigPixel,
    getDefaultLogger("PixelVolumeBuilder", layerLLevel));
...
volumeBuilderConfigPixel.layerEnvelopeR
