///////////////////////////////////////////////////////////////////
// StraightLineSurface.cxx, ACTS project
///////////////////////////////////////////////////////////////////
...
Acts::StraightLineSurface::StraightLineSurface(std::shared_ptr<Acts:: Transform3D> htrans) :
  Surface(htrans),
  m_lineDirection(nullptr),
  m_bounds()
{}
...
// constructors by arguments: boundless surface
Acts::StraightLineSurface::StraightLineSurface(std::unique_ptr<Acts::Transform3D> htrans) :
...
// constructors by arguments
Acts::StraightLineSurface::StraightLineSurface(std::shared_ptr<Acts:: Transform3D> htrans, std::shared_ptr<const CylinderBounds> cbounds) :
  Surface(htrans),
  m_lineDirection(nullptr),
  m_bounds(cbounds)
{}
...
Acts::StraightLineSurface::StraightLineSurface(const Acts::DetectorElementBase& detelement, const Identifier& id) :
...
//copy constructor
Acts::StraightLineSurface::StraightLineSurface(const Acts::StraightLineSurface& slsf):
  Surface(slsf),
  m_lineDirection(nullptr),
...
Acts::StraightLineSurface::StraightLineSurface(const StraightLineSurface& csf, const Acts::Transform3D& transf) :
  Surface(csf, transf),
  m_lineDirection(nullptr),
...
// assignment operator
Acts::StraightLineSurface& Acts::StraightLineSurface::operator=(const Acts::StraightLineSurface& slsf)
{
  if (this!=&slsf){
...
bool Acts::StraightLineSurface::operator==(const Acts::Surface& sf) const
{
  // first check the type not to compare apples with oranges
  const Acts::StraightLineSurface* slsf = dynamic_cast<const Acts::StraightLineSurface*>(&sf);
...
void Acts::StraightLineSurface::localToGlobal(const Acts::Vector2D& locpos,
...
bool Acts::StraightLineSurface::globalToLocal(const Acts::Vector3D& glopos, const Acts::Vector3D& glomom, Acts::Vector2D& locpos) const {
...
// isOnSurface check
bool Acts::StraightLineSurface::isOnSurface(const Acts::Vector3D& glopo,
                                           const BoundaryCheck& bchk) const
{
   ...
   return ( locCand[Acts::eLOC_R] < bounds().r()+bchk.toleranceLoc1 && bounds().insideLoc2(locCand,bchk.toleranceLoc2) );
}

// return the measurement frame
const Acts::RotationMatrix3D Acts::StraightLineSurface::measurementFrame(const Acts::Vector3D&, const Acts::Vector3D& glomom) const
{
...
Acts::Intersection Acts::StraightLineSurface::intersectionEstimate(const Acts::Vector3D& pos,
