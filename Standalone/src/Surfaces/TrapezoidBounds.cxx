                                      ...
                                      double tol2) const
{
  ...
  double k = 2.0 * m_boundValues[TrapezoidBounds::bv_halfY]/(m_boundValues[TrapezoidBounds::bv_maxHalfX] - m_boundValues[TrapezoidBounds::bv_minHalfX]) * ( (locpo[Acts::eLOC_X] > 0.) ? 1.0 : -1.0 );
