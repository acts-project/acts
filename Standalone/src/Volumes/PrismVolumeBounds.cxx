///////////////////////////////////////////////////////////////////
// PrismVolumeBounds.cxx, ACTS project
///////////////////////////////////////////////////////////////////
...
const std::vector<const Acts::Surface*>* Acts::PrismVolumeBounds::decomposeToSurfaces(std::shared_ptr<Acts::Transform3D> transformPtr) const
{
    ...
    tTransform = new Acts::Transform3D(transform*Acts::Translation3D(Acts::Vector3D(0.,0.,-m_halfZ))*Acts::AngleAxis3D(180*Gaudi::Units::deg, Acts::Vector3D(1.,0.,0.)));
...
Acts::PlaneSurface* Acts::PrismVolumeBounds::sideSurf(Acts::Transform3D transform,unsigned int iv1,unsigned int iv2) const
{
  ...
  if ( d.dot(plane->normal())> 0.) { 
    delete plane; 
    tTransform = new Acts::Transform3D(transform*Acts::Translation3D(pos)*Acts::AngleAxis3D(phi+M_PI, Acts::Vector3D(0.,0.,1.))*Acts::AngleAxis3D(-ori*90*Gaudi::Units::deg, Acts::Vector3D(1.,0.,0.)));
    plane = new Acts::PlaneSurface(std::shared_ptr<Acts::Transform3D>(tTransform),new Acts::RectangleBounds(0.5*xsize,m_halfZ)); 
  }
...
MsgStream& Acts::PrismVolumeBounds::dump( MsgStream& sl ) const
{
