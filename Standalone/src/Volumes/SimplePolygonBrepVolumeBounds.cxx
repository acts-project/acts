...
Acts::PlaneSurface* Acts::SimplePolygonBrepVolumeBounds::sideSurf(Acts::Transform3D transform,unsigned int iv1,unsigned int iv2) const
{
  ...
  Acts::Transform3D* tTransform = new Acts::Transform3D(transform*Acts::Translation3D(pos)*Acts::AngleAxis3D(phi, Acts::Vector3D(0.,0.,1.))*Acts::AngleAxis3D(-ori*90*M_PI/180, Acts::Vector3D(1.,0.,0.)));
