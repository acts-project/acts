///////////////////////////////////////////////////////////////////
// SimplePolygonBrepVolumeBounds.cxx, ACTS project
///////////////////////////////////////////////////////////////////
...
Acts::SimplePolygonBrepVolumeBounds::SimplePolygonBrepVolumeBounds(std::vector<std::pair<float,float> > xyVtx, float halez) :
 VolumeBounds(),
 m_halfX(0.),
 m_halfY(0.),
 m_halfZ(halez),
...
{  
  ...
  Acts::Transform3D transXY( Acts::Translation3D(Acts::Vector3D(0.5*(xmin+xmax), 0., 0.))*Acts::Translation3D(Acts::Vector3D(0.,0.5*(ymin+ymax),0.)));
  m_envelope = new Acts::Volume(new Acts::Transform3D(transXY),new Acts::CuboidVolumeBounds(ehalfX,ehalfY,m_halfZ));
  
  processSubVols();
}

Acts::SimplePolygonBrepVolumeBounds::SimplePolygonBrepVolumeBounds(std::vector<std::pair<double,double> > xyVtx, double halez) :
 VolumeBounds(),
 m_halfX(0.),
 m_halfY(0.),
 m_halfZ(halez),
...
Acts::SimplePolygonBrepVolumeBounds::SimplePolygonBrepVolumeBounds(const Acts::SimplePolygonBrepVolumeBounds& trabo) :
  VolumeBounds(),
...
Acts::SimplePolygonBrepVolumeBounds& Acts::SimplePolygonBrepVolumeBounds::operator=(const Acts::SimplePolygonBrepVolumeBounds& trabo)
{
  if (this!=&trabo){
    m_halfX         = trabo.m_halfX;
    m_halfY         = trabo.m_halfY;
...
const std::vector<const Acts::Surface*>* Acts::SimplePolygonBrepVolumeBounds::decomposeToSurfaces(std::shared_ptr<Acts::Transform3D> transformPtr) const
{
  ...
  Acts::PlaneSurface xymPlane(std::shared_ptr<Acts::Transform3D>(tTransform), new Acts::RectangleBounds(m_halfX,m_halfY) );
  Acts::VolumeExcluder* volExcl = new Acts::VolumeExcluder(new Acts::Volume(*m_combinedVolume,Acts::Transform3D(Acts::Translation3D(Acts::Vector3D(0.,0.,-m_halfZ)))));
  retsf->push_back(new Acts::SubtractedPlaneSurface(xymPlane,volExcl,true));
  //  (2) - at positive local z
  tTransform = new Acts::Transform3D(transform*Acts::Translation3D(Acts::Vector3D(0.,0.,m_halfZ)));
  Acts::PlaneSurface xyPlane(std::shared_ptr<Acts::Transform3D>(tTransform),new Acts::RectangleBounds(m_halfX,m_halfY));
  volExcl = new Acts::VolumeExcluder(new Acts::Volume(*m_combinedVolume,Acts::Transform3D(Acts::Translation3D(Acts::Vector3D(0.,0.,m_halfZ)))));
...
// faces in xy
Acts::PlaneSurface* Acts::SimplePolygonBrepVolumeBounds::sideSurf(Acts::Transform3D transform,unsigned int iv1,unsigned int iv2) const
{
  ...
  Acts::Transform3D* tTransform = new Acts::Transform3D(transform*Acts::Translation3D(pos)*Acts::AngleAxis3D(phi, Acts::Vector3D(0.,0.,1.))*Acts::AngleAxis3D(-ori*90*Gaudi::Units::deg, Acts::Vector3D(1.,0.,0.)));
  plane = new Acts::PlaneSurface(std::shared_ptr<Acts::Transform3D>(tTransform),new Acts::RectangleBounds(0.5*xsize,m_halfZ)); 

  return plane;
}

bool Acts::SimplePolygonBrepVolumeBounds::inside(const Acts::Vector3D& pos, double tol) const
{
  return ( m_combinedVolume->inside(pos,tol) ); 
}

void Acts::SimplePolygonBrepVolumeBounds::processSubVols() const
{
...
MsgStream& Acts::SimplePolygonBrepVolumeBounds::dump( MsgStream& sl ) const
{
    return dumpT<MsgStream>(sl);
}

std::ostream& Acts::SimplePolygonBrepVolumeBounds::dump( std::ostream& sl ) const 
{
...
bool Acts::SimplePolygonBrepVolumeBounds::Xor(bool x, bool y) const
...
bool Acts::SimplePolygonBrepVolumeBounds::Left(std::pair<TDD_real_t, TDD_real_t> a, std::pair<TDD_real_t, TDD_real_t> b, std::pair<TDD_real_t, TDD_real_t> c) const 
...
bool Acts::SimplePolygonBrepVolumeBounds::Intersect(std::pair<TDD_real_t, TDD_real_t> a, std::pair<TDD_real_t, TDD_real_t> b, std::pair<TDD_real_t, TDD_real_t> c, std::pair<TDD_real_t, TDD_real_t> d) const
...
bool Acts::SimplePolygonBrepVolumeBounds::InCone(int i, int j, std::vector<std::pair<TDD_real_t, TDD_real_t> > inputVertices) const
...
bool Acts::SimplePolygonBrepVolumeBounds::Diagonal(int i, int j, std::vector<std::pair<TDD_real_t, TDD_real_t> > inputVertices) const
...
std::vector<std::pair<TDD_real_t, TDD_real_t> > Acts::SimplePolygonBrepVolumeBounds::TriangulatePolygon(const std::vector<std::pair<TDD_real_t, TDD_real_t> >& Vertices ) const
{
...
std::vector<std::pair<TDD_real_t, TDD_real_t> > Acts::SimplePolygonBrepVolumeBounds::TriangulatePolygonCheck(const std::vector<std::pair<TDD_real_t, TDD_real_t> >& Vertices ) const
{
