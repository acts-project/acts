...
:::{doxygenfunction} Acts::SeedFilter::filterSeeds_1SpFixed (CandidatesForSpM<InternalSpacePoint<external_spacepoint_t>>&,int&,std::back_insert_iterator<std::vector<Seed<external_spacepoint_t>>>) const
:outline:
:::
