...
| ACTS_LOG_FAILURE_THRESHOLD                    | Deprecated. Seeds the process-wide<br>default log failure threshold; the<br>ACTS_LOG_FAILURE_THRESHOLD environment<br>variable and per-logger thresholds<br>override it. Implies<br>ACTS_ENABLE_LOG_FAILURE_THRESHOLD.<br> type: `string`, default: `""`                    |
