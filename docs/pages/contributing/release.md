@page howto_release How to make a release
...
![The milestones button](release/milestones.png){width=300px}
...
![The next milestone, which has a "closed" button](release/next_milestone.png)
...
![Checkbox to select all visible PRs and issues.](release/select_all_closed.png){width=300px}

> [!note]
> The checkbox will only select the items on the visible page. If there are
> many items, it's possible you'll have to redo this step until it has been
> applied to all items.

Towards the right there's a button called *Milestone* which allows you to
select a milestone to assign. Assign all closed items to the new milestone you
created above.

![Dropdown to assign the selected items to a new milestone](release/milestone_drop.png){width=300px}
