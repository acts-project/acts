...
controls indentation and compression level. Applying material remains a separate `TrackingGeometryMaterial::apply`
...
flattening its intent. Existing legacy paths remain available; no ROOT cleanup or geometry-format migration is included.
