...
[Profiling](./pages/contributing/profiling.md) details the prerequisites for profiling the ACTS project with gperftools.
...
install ACTS' dependencies; see the [building with Spack](./pages/contributing/spack.md) page for
more information.
