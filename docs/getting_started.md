...
| ACTS_EXATRKX_ENABLE_TORCH_AOT       | Add the torch AOT inference<br> type: `bool`, default: `OFF`                                                                                                                                                                       |
| ACTS_EXATRKX_ENABLE_MODULEMAP       | Build the torchscript backend for the<br>exatrkx plugin<br> type: `bool`, default: `OFF`                                                                                                                                           |
| ACTS_EXATRKX_ENABLE_CUDA            | Enable CUDA for the exatrkx plugin<br> type: `bool`, default: `OFF`                                                                                                                                                                |
| ACTS_EXATRKX_ENABLE_TENSORRT        | Enable TensorRT inference<br> type: `bool`, default: `OFF`                                                                                                                                                                         |
