...
repository. They are located under ``$REPO_ROOT/Python/tests``, and
...
Python/tests/requirements.txt`` from the repository root.  You can
...
The tests are implemented by looking up a reference hash from a central data file ``$REPO_ROOT/Python/tests/root_file_hashes.txt``
that looks like
...
.. code-block:: console
   ...
   FAILED Python/tests/test_examples.py::test_seeding
   FAILED Python/tests/test_examples.py::test_material_recording
   FAILED Python/tests/test_examples.py::test_material_mapping
   FAILED Python/tests/test_examples.py::test_ckf_tracks_example_full_seeding
   FAILED Python/tests/test_examples.py::test_ckf_tracks_example_truth_estimate
   FAILED Python/tests/test_examples.py::test_ckf_tracks_example_truth_smeared
