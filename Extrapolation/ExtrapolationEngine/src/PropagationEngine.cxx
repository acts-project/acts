...
{ 
    ...
    if (sfIntersection.valid){
        ...
        if (eCell.pathLimitReached(m_pathLimitTolerance)){
            ...
            eCell.leadParameters = new Ats::NeutralCurvilinearParameters(eCell.leadParameters->position()+pDiff*eCell.leadParameters->momentum().unit(), 
        ...
        eCell.leadParameters = returnCurvilinear ? new Ats::NeutralCurvilinearParameters(sfIntersection.position, eCell.leadParameters->momentum(), 0.) :
