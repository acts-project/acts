...
namespace Ats {
    ...
    class GenericDetectorElement : public DetectorElementBase {
      ...
      public:
        ...
        /**Return the normal of the surface associated with this identifier
         ...
         /** Neighbours for fast access */
         const std::vector<const DetectorElementBase*>& neighbours() const override;
    ...
    inline void GenericDetectorElement::registerNeighbours(std::vector<const DetectorElementBase*>& neighbours) { m_neighbours = neighbours; }

    inline const std::vector<const DetectorElementBase*>& GenericDetectorElement::neighbours() const { return m_neighbours; }    
