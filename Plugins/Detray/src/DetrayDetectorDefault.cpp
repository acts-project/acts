...
// conversion and detector I/O) for the default metadata.
...
ACTS_DETRAY_CONVERT_INSTANTIATION(DetrayMetadata::Default);
ACTS_DETRAY_IO_INSTANTIATION(, DetrayMetadata::Default)
