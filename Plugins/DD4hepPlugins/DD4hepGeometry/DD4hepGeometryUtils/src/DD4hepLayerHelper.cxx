...
void Add4hep::DD4hepLayerHelper::constructLayers(DD4hep::Geometry::DetElement& detElement)
{
...
void Add4hep::DD4hepLayerHelper::createCylinderLayers(DD4hep::Geometry::DetElement& motherDetElement, std::shared_ptr<const Ats::Transform3D> motherTransform) const
{
    //get possible layers
...
void Add4hep::DD4hepLayerHelper::createDiscLayers(DD4hep::Geometry::DetElement& motherDetElement, std::shared_ptr<const Ats::Transform3D> motherTransform) const
{
    //get possible layers
    const  DD4hep::Geometry::DetElement::Children& children = motherDetElement.children();
    //check if volume has layers
...
void Add4hep::DD4hepLayerHelper::createSurfaceVector(DD4hep::Geometry::DetElement& motherDetElement, std::shared_ptr<const Ats::Transform3D> motherTransform, Add4hep::SurfaceVector& surfaces) const
{
