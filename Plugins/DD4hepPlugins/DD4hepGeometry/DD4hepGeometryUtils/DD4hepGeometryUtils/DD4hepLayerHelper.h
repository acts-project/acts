...
namespace Acts {
   ...
   private:
       ...
       void createCylinderLayers(DD4hep::Geometry::DetElement& motherDetElement, std::shared_ptr<const Acts::Transform3D> motherTransform) const;
       /**creates disc shaped layers*/
       void createDiscLayers(DD4hep::Geometry::DetElement& motherDetElement, std::shared_ptr<const Acts::Transform3D> motherTransform) const;
