...
Acts::DD4hepGeometryHelper::extractTransform(
...
Acts::DD4hepGeometryHelper::extractVolumeBounds(
    DD4hep::Geometry::DetElement& detElement)
{
...
void
Acts::DD4hepGeometryHelper::createCylinderLayers(
...
void
Acts::DD4hepGeometryHelper::createDiscLayers(
    DD4hep::Geometry::DetElement&      motherDetElement,
...
Acts::DD4hepGeometryHelper::createSurfaceArray(
    std::vector<DD4hep::Geometry::DetElement>& modules,
...
// either be z or r
std::unique_ptr<Acts::SurfaceArray>
Acts::DD4hepGeometryHelper::binnedSurfaceArray2DPhiL(
...
std::vector<float>
Acts::DD4hepGeometryHelper::createBinValues(
    std::vector<std::pair<float, float>> old)
{
...
bool
Acts::DD4hepGeometryHelper::sortFloatPairs(std::pair<float, float> ap,
