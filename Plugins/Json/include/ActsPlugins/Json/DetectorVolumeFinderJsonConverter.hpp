...
void convert(nlohmann::json& jIndexedVolumes,
             const Experimental::ExternalNavigationDelegate& delegate,
  ...
  using DelegateType = Experimental::IndexGridNavigation<
...
Experimental::ExternalNavigationDelegate fromJson(
