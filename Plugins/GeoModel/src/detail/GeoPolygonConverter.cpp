...
Acts::detail::GeoPolygonConverter::operator()(PVConstLink geoPV,
  ...
  if(nVertices==6){
    ...
    auto diamondBounds = std::make_shared<Acts::DiamondBounds>(halfXnegY, halfXzeroY, halfXposY, halfYnegX, halfYposX);
    if (!sensitive) {
      auto surface =
