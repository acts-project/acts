...
namespace SurfaceGridConverter {
...
/// @param volume is the detector volume that contains the surfaces
...
convert(const GeometryContext& gctx, const Experimental::DetectorVolume& volume,
