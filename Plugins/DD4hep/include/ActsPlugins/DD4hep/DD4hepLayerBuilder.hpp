...
class DD4hepLayerBuilder : public Acts::ILayerBuilder {
 public:
  ...
  DD4hepLayerBuilder(const DD4hepLayerBuilder::Config& config,
 ...
 private:
  ...
  const Acts::LayerVector endcapLayers(
  ...
  void resolveSensitive(
      ...
      std::vector<Acts::SurfaceHandle<const Acts::Surface>>& surfaces) const;
  ...
  Acts::SurfaceHandle<const Acts::Surface> createSensitiveSurface(
