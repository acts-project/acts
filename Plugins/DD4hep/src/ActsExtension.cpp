...
double
Acts::ActsExtension::getValue(const std::string& tag,
...
bool
Acts::ActsExtension::hasValue(const std::string& tag,
                              const std::string& category) const {
  return hasT(m_values, tag, category);
}

bool
Acts::ActsExtension::hasType(const std::string& type,
                             const std::string& category) const {
  return hasT(m_flagStore, type, category);
}

void
Acts::ActsExtension::addType(const std::string& type,
                             const std::string& category,
...
const std::string
Acts::ActsExtension::getType(const std::string& type,
                             const std::string& category) const
    noexcept(false) {
...
std::string
Acts::ActsExtension::toString() const {
