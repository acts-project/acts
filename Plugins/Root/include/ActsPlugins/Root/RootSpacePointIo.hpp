...
class RootSpacePointIo {
 public:
  ...
  void write(const Acts::Experimental::ConstSpacePointProxy2& spacePoint);

  /// @brief Write the space points to the tree
  ///
  /// @param spacePoints the space points to write
  /// @param ttree the TTree to write to
  void write(const Acts::Experimental::SpacePointContainer2& spacePoints,
             TTree& ttree);
  ...
  void read(Acts::Experimental::MutableSpacePointProxy2& spacePoint,
