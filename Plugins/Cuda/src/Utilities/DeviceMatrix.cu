...
DeviceMatrix<T>::get(std::size_t row, std::size_t col) {
...
DeviceMatrix<T>::get(std::size_t row, std::size_t col) const {
...
template <typename T>
typename DeviceMatrix<T>::Variable_t*
DeviceMatrix<T>::getPtr(std::size_t row, std::size_t col) {
...
template <typename T>
const typename DeviceMatrix<T>::Variable_t*
DeviceMatrix<T>::getPtr(std::size_t row, std::size_t col) const {
