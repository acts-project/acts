...
ExaTrkXTrackFindingTritonTorch::ExaTrkXTrackFindingTritonTorch(
    ...
    : ExaTrkXTrackFindingBase("ExaTrkXTrackFindingTritonTorch", config.verbose),
      m_cfg(config) {
  bool verbose = false;
...
void ExaTrkXTrackFindingTritonTorch::getTracks(
  ...
  //     std::cout << "My embedding shape is: " << embedInputShape[0] << " " <<
  //     embedInputShape[1] << std::endl;
  // }
  ...
  buildEdges(eOutputData, edgeList, numSpacepoints, m_cfg.embeddingDim,
