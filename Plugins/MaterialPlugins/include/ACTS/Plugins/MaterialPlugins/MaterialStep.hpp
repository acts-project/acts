...
namespace Acts {
    ...
    ///
    /// The MaterialStep class is needed to store the material properties (material + step length) at a given
    ...
    public:
        ...
        /// @param mat the material properties (material + step length) at the given position
        ...
        /// Assignment operator
        MaterialStep& operator=(const Acts::MaterialStep& mstep);
    ...
    private:
        /// the global three dimensional position of the material step
        Position                            m_position;
        /// the accumulated material of the step containing the material and the step length 
        MaterialProperties                  m_material;
    };
}

inline const Acts::MaterialStep::Position Acts::MaterialStep::position() {return m_position;}
/// return method for the material properties
inline const Acts::MaterialProperties Acts::MaterialStep::material() {return m_material;}
