...
namespace Acts {
  ...
  public:
    ...
    bool set3(Acts::Seed<SpacePoint>&);

    void set2(Acts::Seed<SpacePoint>&);
  ...
  template <typename SpacePoint>
  inline InternalSeed<SpacePoint>::InternalSeed
    (SPForSeed<SpacePoint>*& s0,SPForSeed<SpacePoint>*& s1,SPForSeed<SpacePoint>*& s2,float z)
    {
  ...
  template <typename SpacePoint>
  inline InternalSeed<SpacePoint>::InternalSeed (const InternalSeed& sp): m_s0(sp.m_s0),m_s1(sp.m_s1),m_s2(sp.m_s2)
    {
      *this = sp;
    }
  ...
  template <typename SpacePoint>
  inline void InternalSeed<SpacePoint>::set
    (SPForSeed<SpacePoint>*& s0,SPForSeed<SpacePoint>*& s1,SPForSeed<SpacePoint>*& s2,float z)
    {
      m_z   = z ;
      m_s0  = s0;
  ...
  template<typename SpacePoint>
  inline void InternalSeed<SpacePoint>::set2(Acts::Seed<SpacePoint>& s)
    {
      s.erase();
  ...
  template<typename SpacePoint>
  inline bool InternalSeed<SpacePoint>::set3(Acts::Seed<SpacePoint>& s)
    {
