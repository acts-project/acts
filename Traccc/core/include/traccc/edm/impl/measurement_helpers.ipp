  ...
  switch (meas.subspace()[0]) {
    case detray::e_bound_loc0:
      getter::element(pos, 0, 0) =
          static_cast<typename algebra_t::value_type>(meas.local_position()[0]);
      if constexpr (D == 2u) {
    ...
    case detray::e_bound_loc1:
      getter::element(pos, 0, 0) =
          static_cast<typename algebra_t::value_type>(meas.local_position()[1]);
      if constexpr (D == 2u) {
        getter::element(pos, 1, 0) =
            static_cast<typename algebra_t::value_type>(
  ...
  switch (meas.subspace()[0]) {
    case detray::e_bound_loc0:
      getter::element(cov, 0, 0) =
          static_cast<typename algebra_t::value_type>(meas.local_variance()[0]);
      if constexpr (D == 2u) {
    ...
    case detray::e_bound_loc1:
      getter::element(cov, 0, 0) =
          static_cast<typename algebra_t::value_type>(meas.local_variance()[1]);
      if constexpr (D == 2u) {
        getter::element(cov, 0, 1) = 0.f;
        getter::element(cov, 1, 0) = 0.f;
        getter::element(cov, 1, 1) =
