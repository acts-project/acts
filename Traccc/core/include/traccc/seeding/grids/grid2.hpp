...
template <template <template <typename...> class, template <typename...> class,
                    ...
                    unsigned int> class populator_t,
          template <template <typename, std::size_t> class,
                    template <typename...> class> class axis_p0_t,
          template <template <typename, std::size_t> class,
                    template <typename...> class> class axis_p1_t,
...
class grid2 {
 public:
  ...
  grid2(
      ...
      const bare_value m_invalid = detray::detail::invalid_value<bare_value>())
      : _axis_p0(mr),
        _axis_p1(mr),
        _data_serialized(&mr),
  ...
  DETRAY_HOST
  grid2(
      const axis_p0_type &axis_p0, const axis_p1_type &axis_p1,
      vecmem::memory_resource &mr,
      const bare_value m_invalid = detray::detail::invalid_value<bare_value>())
      : _axis_p0(axis_p0, mr),
        _axis_p1(axis_p1, mr),
  ...
  DETRAY_HOST
  grid2(
      axis_p0_type &&axis_p0, axis_p1_type &&axis_p1,
      vecmem::memory_resource &mr,
      const bare_value m_invalid = detray::detail::invalid_value<bare_value>())
...
struct const_grid2_view {
  ...
  const_grid2_view(
      ...
      const axis_data<typename grid2_t::axis_p1_type, const scalar>
          &axis_p1_view,
      const typename grid2_t::populator_type::const_vector_view_type &data_view)
...
struct const_grid2_data : public const_grid2_view<grid2_t> {
  ...
  const_grid2_data(const grid2_t &grid, vecmem::memory_resource &resource)
    ...
    const_grid2_view<grid2_t>::_axis_p0_view = traccc::get_data(const_axis_p0);
    const typename grid2_t::axis_p1_type &const_axis_p1 = _axis_p1;
    const_grid2_view<grid2_t>::_axis_p1_view = traccc::get_data(const_axis_p1);
