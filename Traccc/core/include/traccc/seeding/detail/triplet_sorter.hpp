 ...
 public:
  ...
  bool operator()(const triplet& seed1, const triplet& seed2) const {
    ...
    // the y and z coordinates of the spacepoints.
      ...
      const edm::spacepoint_collection::const_device::const_proxy_type spB1 =
          m_spacepoints->at(
              m_sp_grid->bin(seed1.sp1.bin_idx)[seed1.sp1.sp_idx]);
      const edm::spacepoint_collection::const_device::const_proxy_type spT1 =
          m_spacepoints->at(
              m_sp_grid->bin(seed1.sp3.bin_idx)[seed1.sp3.sp_idx]);
      const edm::spacepoint_collection::const_device::const_proxy_type spB2 =
          m_spacepoints->at(
              m_sp_grid->bin(seed2.sp1.bin_idx)[seed2.sp1.sp_idx]);
      const edm::spacepoint_collection::const_device::const_proxy_type spT2 =
          m_spacepoints->at(
