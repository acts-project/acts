...
/// Function creating the linearised circle of one middle-bottom doublet
///
...
/// @param[in] mb_doublet_view     Collection storing the midBot doublets
...
/// @param[out] out_view           Linearised circles of the midBot doublets
///
TRACCC_HOST_DEVICE
...
#include "traccc/seeding/device/impl/make_mid_bot_lincircles.ipp"
