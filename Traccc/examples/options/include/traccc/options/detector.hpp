...
class detector : public interface {
 public:
  ...
  std::string detector_file = "geometries/odd/odd-detray_geometry_detray.json";
  /// The file containing the material description
  std::string material_file = "geometries/odd/odd-detray_material_detray.json";
  /// The file containing the surface grid description
  std::string grid_file = "geometries/odd/odd-detray_surface_grids_detray.json";
  ...
  std::string conditions_file = "geometries/odd/odd-digi-geometric-config.json";
