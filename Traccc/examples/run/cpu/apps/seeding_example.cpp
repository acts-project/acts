...
int seq_run(const traccc::opts::track_seeding& seeding_opts,
  ...
  traccc::host::greedy_ambiguity_resolution_algorithm host_ambiguity_resolution(
      host_ambiguity_config, host_mr, logger().clone("AmbiguityResolution"));
        ...
        host_detector_visitor<detector_type_list>(
            detector, [&]<typename detector_traits_t>(
              ...
              fit_performance_writer.write(
                  track_candidates.tracks.at(i), track_candidates.states,
...
int main(int argc, char* argv[]) {
  ...
  // Run the application.
  return seq_run(seeding_opts, finding_opts, propagation_opts, resolution_opts,
                 fitting_opts, input_opts, detector_opts, bfield_opts,
