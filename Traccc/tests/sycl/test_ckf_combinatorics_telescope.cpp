...
TEST_P(CkfCombinatoricsTelescopeTests, Run) {
  ...
  traccc::io::read_detector(
      ...
      std::filesystem::path(path / "telescope_detector_geometry.json").native(),
  ...
  traccc::sycl::combinatorial_kalman_filter_algorithm::config_type cfg_no_limit;
